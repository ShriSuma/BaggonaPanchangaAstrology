...
# Update PAGE7_DICT with extended steps & instructions
new_page7_dict = '''const PAGE7_DICT: Record<string, {
  chapterTitle: string;
  subTitle: string;
...
if dict_start != -1 and dict_end != -1:
    content = content[:dict_start] + new_page7_dict + "\n\n" + content[dict_end:]

# Replace Page 7 JSX block to have centered QR code box and 5 step-by-step instructions with larger font size
...
print("Updated Page 7 with centered QR code card, larger font size, and 5 detailed steps successfully!")
