...
target_custom_pooja_end = """    fruit: {
      ...
      te: "సకల కోరికల ಈడేರಿಕ, దివ్య ರಕ್ಷಣ ಮತ್ತು ಕುಟುಂಬ ಶಾಂತಿ",
      ta: "சகல காரிய சித்தி, தெய்வீக பாதுகாப்பு மற்றும் குடும்ப அமைதி"
    }
  }"""

if "narayanabali_tripindi:" not in content:
    content = content.replace(target_custom_pooja_end, target_custom_pooja_end + combined_vidhis)
    with open(file_priests, "w", encoding="utf-8") as f:
        f.write(content)
    print("Inserted narayanabali_tripindi and narayanabali_pretoddhara into sevaPriestDirectory.ts!")
else:
