filepath = "src/components/seva/PriestQrGeneratorTab.tsx"

new_tab_code = '''import React, { useEffect, useMemo, useState } from "react";
...
print("Updated PriestQrGeneratorTab.tsx with language selector radio buttons.")
