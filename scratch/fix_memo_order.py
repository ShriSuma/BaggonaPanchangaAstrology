...
# Swap page5Data and dashaCardsData block order
old_hook_block = '''  // ─── DYNAMIC PAGE 4 DATA (Natal Planets, Yogas & Doshas) ───
...
new_hook_block = '''  const dashaCardsData = React.useMemo(() => {
    if (!birthKundli) return [];
...
print("Swapped memo hooks order successfully.")
