...
# Helper function to ensure toKnDigits is available at top of component
helper_kn = '''
...
# Replace the Page 1 Top 2 Sections (Header Box & Devotee Identity Box)
old_p1_top_sections = re.search(r'\{\/\* Top Header Box with Gokarna Atmalinga Sacred Emblem \*\}[\s\S]*?\{\/\* Full Page Width Chief Priest Ashirvachana', content)

new_p1_top_sections = '''{/* Top Header Box with Gokarna Atmalinga Sacred Emblem - Clean Spacing & Zero Collision */}
          <div style={{
            textAlign: "center",
          ...
          {/* Full Page Width Chief Priest Ashirvachana'''

if old_p1_top_sections:
    content = content.replace(old_p1_top_sections.group(0), new_p1_top_sections + "\n          {/* Full Page Width Chief Priest Ashirvachana")
    print("Page 1 top sections updated successfully!")
else:
    print("Failed to match Page 1 top sections pattern!")
