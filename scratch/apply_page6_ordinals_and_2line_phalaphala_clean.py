...
s_marker = "  // ─── DYNAMIC PAGE 6 DATA (8-Month Roadmap - 240 Days) ───"
e_marker = "  return ("

s_idx = content.find(s_marker)
# Find return ( AFTER s_idx
e_idx = content.find("  return (", s_idx)
...
if s_idx != -1 and e_idx != -1:
    content = content[:s_idx] + new_p6_code + content[e_idx:]
    with open(filepath, "w", encoding="utf-8") as f:
        f.write(content)
    print("Cleanly updated Page 6 memo hook successfully.")
