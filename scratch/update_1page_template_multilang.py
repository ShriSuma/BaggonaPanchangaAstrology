filepath = "src/components/seva/pdf/PriestQrCard1PageTemplate.tsx"
...
print("Rewrote PriestQrCard1PageTemplate.tsx for 5-language support and double devotee name.")
