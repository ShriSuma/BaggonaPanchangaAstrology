...
file_content = '''import React, { useState, useRef, useEffect } from "react";
    ...
    <div className="space-y-6 pb-12">
      ...
      {activeResult && (
        <div style={{ position: "absolute", left: "-9999px", top: "-9999px" }}>
          <SankhyaShastraPdfTemplate result={activeResult} devoteeName={devoteeName} lang={selectedLang} messages={messages} />
        </div>
      )}
    </div>
  );
...
print("UPDATED_SANKHYA_PAGE_SUCCESS")
