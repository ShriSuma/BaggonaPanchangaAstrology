    ...
    <div id="seva-print-royal-booklet-container" style={{ backgroundColor: "#2D3748", padding: "20px 0" }}>
      ...
      <div className="pdf-page" style={pageStyle}>
        <div style={{ ...frameStyle, gap: "10px" }}>
          ...
          {/* 5 Dasha-Bhukti Cards with Perfect Middle Alignment & Enhanced Font Sizes */}
          <div style={{ display: "flex", flexDirection: "column", gap: "10px" }}>
            ...
            <div style={{
              ...
              <div style={{ fontSize: "14px", fontWeight: 800, color: "#78350F", marginBottom: "5px", display: "flex", justifyContent: "space-between", alignItems: "center" }}>
                <span style={{ display: "inline-flex", alignItems: "center" }}>📌 ಗುರು ಮಹಾದಶಾ • ಬುಧ ಅಂತರ್ದಶಾ</span>
                <span style={{
                  fontSize: "11px",
                  color: "#92400E",
                  background: "#FEF3C7",
            ...
            <div style={{
              ...
              <div style={{ fontSize: "14px", fontWeight: 800, color: "#78350F", marginBottom: "5px", display: "flex", justifyContent: "space-between", alignItems: "center" }}>
                <span style={{ display: "inline-flex", alignItems: "center" }}>📌 ಗುರು ಮಹಾದಶಾ • ಕೇತು ಅಂತರ್ದಶಾ</span>
                <span style={{
                  fontSize: "11px",
                  color: "#5B21B6",
                  background: "#F5F3FF",
            ...
            <div style={{
              ...
              <div style={{ fontSize: "14px", fontWeight: 900, color: "#78350F", marginBottom: "5px", display: "flex", justifyContent: "space-between", alignItems: "center" }}>
                <span style={{ display: "inline-flex", alignItems: "center" }}>🌟 ಗುರು ಮಹಾದಶಾ • ಶುಕ್ರ ಅಂತರ್ದಶಾ (ರಾಜಯೋಗ ಕಾಲ)</span>
                <span style={{
                  fontSize: "11px",
                  color: "#78350F",
            ...
            <div style={{
              ...
              <div style={{ fontSize: "14px", fontWeight: 800, color: "#78350F", marginBottom: "5px", display: "flex", justifyContent: "space-between", alignItems: "center" }}>
                <span style={{ display: "inline-flex", alignItems: "center" }}>📌 ಗುರು ಮಹಾದಶಾ • ಸೂರ್ಯ ಅಂತರ್ದಶಾ</span>
                <span style={{
                  fontSize: "11px",
                  color: "#047857",
                  background: "#ECFDF5",
            ...
            <div style={{
              ...
              <div style={{ fontSize: "14px", fontWeight: 800, color: "#78350F", marginBottom: "5px", display: "flex", justifyContent: "space-between", alignItems: "center" }}>
                <span style={{ display: "inline-flex", alignItems: "center" }}>📌 ಶನಿ ಮಹಾದಶಾ • ಶನಿ ಅಂತರ್ದಶಾ</span>
                <span style={{
                  fontSize: "11px",
                  color: "#92400E",
                  background: "#FEF3C7",
