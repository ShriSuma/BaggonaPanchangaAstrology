...
export const RoyalBooklet8PageTemplate: React.FC<RoyalBooklet8PageTemplateProps> = ({
  ...
  return (
    <div id="seva-print-royal-booklet-container" style={{ backgroundColor: "#2D3748", padding: "20px 0" }}>
      ...
      {/* ─────────────────────────────────────────────────────────────
          PAGE 3: EXACT MATCH TO PDF (45) PAGE 3
         ───────────────────────────────────────────────────────────── */}
      <div className="pdf-page" style={pageStyle}>
        <div style={frameStyle}>
          {/* Header Box */}
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: "8px" }}>
            ...
            <div style={{ background: "#FFFBEB", border: "1.5px solid #D97706", borderRadius: "8px", padding: "8px 12px" }}>
              <div style={{ fontSize: "13px", fontWeight: 800, color: "#78350F", marginBottom: "4px", display: "flex", justifyContent: "space-between" }}>
                <span>📌 guru mahadasha · budha antardasha</span>
                <span style={{ fontSize: "10.5px", color: "#92400E", background: "#FEF3C7", padding: "1px 8px", borderRadius: "10px", fontWeight: 700 }}>✨ ವಿದ್ಯಾ & ಬುದ್ಧಿ ಸಿದ್ಧಿ</span>
              </div>
              <div style={{ fontSize: "11.5px", color: "#78350F", fontWeight: 700, marginBottom: "6px", background: "#FEF3C7", padding: "3px 8px", borderRadius: "4px" }}>
                🗓️ ಅವಧಿ: ೨೦೧೭-೦೫-೧೨ ರಿಂದ ೨೦೧೯-೦೯-೧೮ | (ವಯಸ್ಸು: ೨೪ - ೨೬ ವರ್ಷ)
              </div>
              <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "4px 14px", fontSize: "11.5px", lineHeight: "1.55" }}>
                ...
                <div><span style={{ color: "#D97706" }}>💰</span> <strong style={{ color: "#047857" }}>ಧನ & ಆಸ್ತಿ:</strong> ವ್ಯಾಪಾರದಲ್ಲಿ ಶೇಕಡ 20%+ ಲಾಭ ವೃದ್ಧಿ, ನೂತನ ಹೂಡಿಕೆ ಹಾಗೂ ಶೇರುಗಳಲ್ಲಿ ಧನ ಸಮೃದ್ಧಿ.</div>
            ...
            <div style={{ background: "#FFFBEB", border: "1.5px solid #D97706", borderRadius: "8px", padding: "8px 12px" }}>
              <div style={{ fontSize: "13px", fontWeight: 800, color: "#78350F", marginBottom: "4px", display: "flex", justifyContent: "space-between" }}>
                <span>📌 guru mahadasha · ketu antardasha</span>
                <span style={{ fontSize: "10.5px", color: "#92400E", background: "#FEF3C7", padding: "1px 8px", borderRadius: "10px", fontWeight: 700 }}>🕉️ ಆಧ್ಯಾತ್ಮ & ಜ್ಞಾನ ತಪಸ್ಸು</span>
              </div>
              <div style={{ fontSize: "11.5px", color: "#78350F", fontWeight: 700, marginBottom: "6px", background: "#FEF3C7", padding: "3px 8px", borderRadius: "4px" }}>
                🗓️ ಅವಧಿ: ೨೦೧೯-೦೯-೧೮ ರಿಂದ ೨೦೨೦-೦೮-೨೪ | (ವಯಸ್ಸು: ೨೬ - ೨೭ ವರ್ಷ)
              </div>
              <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "4px 14px", fontSize: "11.5px", lineHeight: "1.55" }}>
            ...
            <div style={{ background: "#FFFBEB", border: "1.5px solid #D97706", borderRadius: "8px", padding: "8px 12px" }}>
              <div style={{ fontSize: "13px", fontWeight: 800, color: "#78350F", marginBottom: "4px", display: "flex", justifyContent: "space-between" }}>
                <span>🌟 guru mahadasha · shukra antardasha (rajayoga kala)</span>
                <span style={{ fontSize: "10.5px", color: "#92400E", background: "#FEF3C7", padding: "1px 8px", borderRadius: "10px", fontWeight: 700 }}>👑 ಅತ್ಯುನ್ನತ ರಾಜಯೋಗ ಫಲ</span>
              </div>
              <div style={{ fontSize: "11.5px", color: "#78350F", fontWeight: 700, marginBottom: "6px", background: "#FEF3C7", padding: "3px 8px", borderRadius: "4px" }}>
                🗓️ ಅವಧಿ: ೨೦೨೦-೦೮-೨೪ ರಿಂದ ೨೦೨೩-೦೪-೨೪ | (ವಯಸ್ಸು: ೨೭ - ೨೯ ವರ್ಷ)
              </div>
              <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "4px 14px", fontSize: "11.5px", lineHeight: "1.55" }}>
            ...
            <div style={{ background: "#FFFBEB", border: "1.5px solid #D97706", borderRadius: "8px", padding: "8px 12px" }}>
              <div style={{ fontSize: "13px", fontWeight: 800, color: "#78350F", marginBottom: "4px", display: "flex", justifyContent: "space-between" }}>
                <span>📌 guru mahadasha · surya antardasha</span>
                <span style={{ fontSize: "10.5px", color: "#92400E", background: "#FEF3C7", padding: "1px 8px", borderRadius: "10px", fontWeight: 700 }}>⛳ ಅಧಿಕಾರ & ಸರ್ಕಾರಿ ಜಯ</span>
              </div>
              <div style={{ fontSize: "11.5px", color: "#78350F", fontWeight: 700, marginBottom: "6px", background: "#FEF3C7", padding: "3px 8px", borderRadius: "4px" }}>
                🗓️ ಅವಧಿ: ೨೦೨೩-೦೪-೨೪ ರಿಂದ ೨೦೨೪-೦೧-೧೦ | (ವಯಸ್ಸು: ೨೯ - ೩೦ ವರ್ಷ)
              </div>
              <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "4px 14px", fontSize: "11.5px", lineHeight: "1.55" }}>
            ...
            <div style={{ background: "#FFFBEB", border: "1.5px solid #D97706", borderRadius: "8px", padding: "8px 12px" }}>
              <div style={{ fontSize: "13px", fontWeight: 800, color: "#78350F", marginBottom: "4px", display: "flex", justifyContent: "space-between" }}>
                <span>📌 shani mahadasha · shani antardasha</span>
                <span style={{ fontSize: "10.5px", color: "#92400E", background: "#FEF3C7", padding: "1px 8px", borderRadius: "10px", fontWeight: 700 }}>⚖️ ಸ್ಥಿರ ಧರ್ಮ ಕರ್ತವ್ಯ</span>
              </div>
              <div style={{ fontSize: "11.5px", color: "#78350F", fontWeight: 700, marginBottom: "6px", background: "#FEF3C7", padding: "3px 8px", borderRadius: "4px" }}>
