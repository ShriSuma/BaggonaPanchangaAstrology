    ...
    <div id="seva-print-royal-booklet-container" style={{ backgroundColor: "#2D3748", padding: "20px 0" }}>
      ...
      <div className="pdf-page" style={pageStyle}>
        <div style={{ ...frameStyle, gap: "10px" }}>
          ...
          {/* 8-Month Detailed Grid (2 Columns x 4 Rows - Expanded 2-Line Phalaphala) */}
          <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "10px" }}>
            {/* Month 1 */}
            <div style={{ background: "#FFFFFF", border: "1.5px solid #FCD34D", borderRadius: "8px", padding: "10px 12px", boxShadow: "0 1px 3px rgba(0,0,0,0.03)" }}>
              <div style={{ fontSize: "13px", fontWeight: 800, color: "#78350F", marginBottom: "5px", display: "flex", justifyContent: "space-between", alignItems: "center" }}>
                <span>🗓️ ೧ ನೇ ತಿಂಗಳು (ಸೆಪ್ಟೆಂಬರ್ ೨೦೨೬)</span>
                <span style={{ fontSize: "10.5px", background: "#FEF3C7", border: "1px solid #F59E0B", color: "#92400E", padding: "2px 8px", borderRadius: "8px", fontWeight: 700 }}>ವೃತ್ತಿ ವೃದ್ಧಿ</span>
              </div>
            ...
            {/* Month 2 */}
            <div style={{ background: "#ECFDF5", border: "1.5px solid #10B981", borderRadius: "8px", padding: "10px 12px", boxShadow: "0 1px 3px rgba(0,0,0,0.03)" }}>
              <div style={{ fontSize: "13px", fontWeight: 800, color: "#065F46", marginBottom: "5px", display: "flex", justifyContent: "space-between", alignItems: "center" }}>
                <span>🗓️ ೨ ನೇ ತಿಂಗಳು (ಅಕ್ಟೋಬರ್ ೨೦೨೬)</span>
                <span style={{ fontSize: "10.5px", background: "#D1FAE5", border: "1px solid #10B981", color: "#065F46", padding: "2px 8px", borderRadius: "8px", fontWeight: 700 }}>ಧನ ಸಮೃದ್ಧಿ</span>
              </div>
              <div style={{ fontSize: "11.5px", lineHeight: "1.5", color: "#064E3B" }}>
            ...
            {/* Month 3 */}
            <div style={{ background: "#F5F3FF", border: "1.5px solid #8B5CF6", borderRadius: "8px", padding: "10px 12px", boxShadow: "0 1px 3px rgba(0,0,0,0.03)" }}>
              <div style={{ fontSize: "13px", fontWeight: 800, color: "#5B21B6", marginBottom: "5px", display: "flex", justifyContent: "space-between", alignItems: "center" }}>
                <span>🗓️ ೩ ನೇ ತಿಂಗಳು (ನವೆಂಬರ್ ೨೦೨೬)</span>
                <span style={{ fontSize: "10.5px", background: "#EDE9FE", border: "1px solid #8B5CF6", color: "#5B21B6", padding: "2px 8px", borderRadius: "8px", fontWeight: 700 }}>ಕುಟುಂಬ ಸೌಖ್ಯ</span>
              </div>
              <div style={{ fontSize: "11.5px", lineHeight: "1.5", color: "#4C1D95" }}>
            ...
            <div style={{ background: "#FFFFFF", border: "1.5px solid #FCD34D", borderRadius: "8px", padding: "10px 12px", boxShadow: "0 1px 3px rgba(0,0,0,0.03)" }}>
              <div style={{ fontSize: "13px", fontWeight: 800, color: "#78350F", marginBottom: "5px", display: "flex", justifyContent: "space-between", alignItems: "center" }}>
                ...
                <span style={{ fontSize: "10.5px", background: "#FEF3C7", border: "1px solid #F59E0B", color: "#92400E", padding: "2px 8px", borderRadius: "8px", fontWeight: 700 }}>ಆಸ್ತಿ & ವಾಹನ</span>
              </div>
              <div style={{ fontSize: "11.5px", lineHeight: "1.5", color: "#3F2A12" }}>
            ...
            <div style={{ background: "#FEF2F2", border: "1.5px solid #EF4444", borderRadius: "8px", padding: "10px 12px", boxShadow: "0 1px 3px rgba(239, 68, 68, 0.08)" }}>
              <div style={{ fontSize: "13px", fontWeight: 800, color: "#991B1B", marginBottom: "5px", display: "flex", justifyContent: "space-between", alignItems: "center" }}>
                <span>🗓️ ೫ ನೇ ತಿಂಗಳು (ಜನವರಿ ೨೦೨೭)</span>
                <span style={{ fontSize: "10.5px", background: "#FEE2E2", border: "1px solid #EF4444", color: "#991B1B", padding: "2px 8px", borderRadius: "8px", fontWeight: 800 }}>⚠️ ಭುಕ್ತಿ ಸಂಧಿ - ಜಾಗೃತಿ</span>
              </div>
              <div style={{ fontSize: "11.5px", lineHeight: "1.5", color: "#7F1D1D" }}>
            ...
            <div style={{ background: "#ECFDF5", border: "1.5px solid #10B981", borderRadius: "8px", padding: "10px 12px", boxShadow: "0 1px 3px rgba(0,0,0,0.03)" }}>
              <div style={{ fontSize: "13px", fontWeight: 800, color: "#065F46", marginBottom: "5px", display: "flex", justifyContent: "space-between", alignItems: "center" }}>
                ...
                <span style={{ fontSize: "10.5px", background: "#D1FAE5", border: "1px solid #10B981", color: "#065F46", padding: "2px 8px", borderRadius: "8px", fontWeight: 700 }}>ರಾಜಯೋಗ ಬಲ</span>
              </div>
              <div style={{ fontSize: "11.5px", lineHeight: "1.5", color: "#064E3B" }}>
            ...
            {/* Month 7 */}
            <div style={{ background: "#EFF6FF", border: "1.5px solid #3B82F6", borderRadius: "8px", padding: "10px 12px", boxShadow: "0 1px 3px rgba(0,0,0,0.03)" }}>
              <div style={{ fontSize: "13px", fontWeight: 800, color: "#1E40AF", marginBottom: "5px", display: "flex", justifyContent: "space-between", alignItems: "center" }}>
                <span>🗓️ ೭ ನೇ ತಿಂಗಳು (ಮಾರ್ಚ್ ೨೦೨೭)</span>
                <span style={{ fontSize: "10.5px", background: "#DBEAFE", border: "1px solid #3B82F6", color: "#1E40AF", padding: "2px 8px", borderRadius: "8px", fontWeight: 700 }}>ವಿದ್ಯಾ & ಬೌದ್ಧಿಕ</span>
              </div>
              <div style={{ fontSize: "11.5px", lineHeight: "1.5", color: "#1E3A8A" }}>
            ...
            <div style={{ background: "#FFFBEB", border: "1.5px solid #F59E0B", borderRadius: "8px", padding: "10px 12px", boxShadow: "0 1px 3px rgba(0,0,0,0.03)" }}>
              <div style={{ fontSize: "13px", fontWeight: 800, color: "#78350F", marginBottom: "5px", display: "flex", justifyContent: "space-between", alignItems: "center" }}>
                <span>🗓️ ೮ ನೇ ತಿಂಗಳು (ಏಪ್ರಿಲ್ ೨೦೨೭)</span>
                <span style={{ fontSize: "10.5px", background: "#FEF3C7", border: "1px solid #F59E0B", color: "#92400E", padding: "2px 8px", borderRadius: "8px", fontWeight: 700 }}>⚡ ಶತ್ರು ಜಯ & ರಕ್ಷಣೆ</span>
              </div>
              <div style={{ fontSize: "11.5px", lineHeight: "1.5", color: "#3F2A12" }}>
