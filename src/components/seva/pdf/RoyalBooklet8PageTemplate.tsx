...
const PAGE7_DICT: Record<string, {
  ...
  te: {
    ...
    step5: "దశ 5: 'Add All' / Save క్లిక్ చేసి 90 రోజులు క్యాలెಂಡర్‌కి సింక్ చేయండి!",
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: "10px" }}>
            ...
            <div style={{
              ...
              <div style={{ fontSize: "14px", fontWeight: 800, color: "#78350F", marginBottom: "4px", display: "flex", justifyContent: "space-between", alignItems: "center" }}>
                <span style={{ display: "inline-flex", alignItems: "center", lineHeight: "1.3" }}>📌 ಗುರು ಮಹಾದಶಾ • ಶನಿ ಅಂತರ್ದಶಾ (ಪ್ರಸ್ತುತ ನಡವಳಿಕೆ)</span>
                <span style={{
                  fontSize: "11px",
                  color: "#92400E",
                  background: "#FEF3C7",
            ...
            <div style={{
              ...
              <div style={{ fontSize: "14px", fontWeight: 800, color: "#78350F", marginBottom: "4px", display: "flex", justifyContent: "space-between", alignItems: "center" }}>
                <span style={{ display: "inline-flex", alignItems: "center", lineHeight: "1.3" }}>📌 ಗುರು ಮಹಾದಶಾ • ಬುಧ ಅಂತರ್ದಶಾ</span>
                <span style={{
                  fontSize: "11px",
                  color: "#92400E",
                  background: "#FEF3C7",
            ...
            <div style={{
              ...
              <div style={{ fontSize: "14px", fontWeight: 900, color: "#78350F", marginBottom: "4px", display: "flex", justifyContent: "space-between", alignItems: "center" }}>
                <span style={{ display: "inline-flex", alignItems: "center", lineHeight: "1.3" }}>🌟 ಗುರು ಮಹಾದಶಾ • ಶುಕ್ರ ಅಂತರ್ದಶಾ (ಅತ್ಯುನ್ನತ ರಾಜಯೋಗ ಕಾಲ)</span>
                <span style={{
                  fontSize: "11px",
                  color: "#78350F",
            ...
            <div style={{
              ...
              <div style={{ fontSize: "14px", fontWeight: 800, color: "#78350F", marginBottom: "4px", display: "flex", justifyContent: "space-between", alignItems: "center" }}>
                <span style={{ display: "inline-flex", alignItems: "center", lineHeight: "1.3" }}>📌 ಗುರು ಮಹಾದಶಾ • ಸೂರ್ಯ ಅಂತರ್ದಶಾ</span>
                <span style={{
                  fontSize: "11px",
                  color: "#047857",
                  background: "#ECFDF5",
            ...
            <div style={{
              ...
              <div style={{ fontSize: "14px", fontWeight: 800, color: "#78350F", marginBottom: "4px", display: "flex", justifyContent: "space-between", alignItems: "center" }}>
                <span style={{ display: "inline-flex", alignItems: "center", lineHeight: "1.3" }}>📌 ಶನಿ ಮಹಾದಶಾ • ಶನಿ ಅಂತರ್ದಶಾ</span>
                <span style={{
                  fontSize: "11px",
                  color: "#92400E",
                  background: "#FEF3C7",
      ...
      <div className="pdf-page" style={pageStyle}>
        <div style={{ ...frameStyle, gap: "10px" }}>
          ...
          <div style={{
            ...
            <div style={{ fontSize: "16px", fontWeight: 800, textTransform: "uppercase", color: "#FEF3C7", textShadow: "0 1px 2px rgba(0,0,0,0.4)" }}>
          ...
          <div style={{
            ...
            <div style={{ fontSize: "12.5px", fontWeight: 800, color: "#78350F", marginBottom: "3px" }}>
              {(PAGE7_DICT[code] || PAGE7_DICT.en).personalIntroHeader}
            </div>
            <div style={{ fontSize: "12px", lineHeight: "1.55", color: "#451A03", textAlign: "justify", fontWeight: 600 }}>
              {(PAGE7_DICT[code] || PAGE7_DICT.en).personalIntroText}
            </div>
          </div>

          {/* Section 2: Step-by-Step Installation Instructions (Larger Font 12.5px) */}
          <div style={{
            background: "#FFFBEB",
            border: "1.5px solid #D97706",
            borderRadius: "10px",
            ...
            <div style={{ fontSize: "12.5px", lineHeight: "1.65", color: "#3F2A12", display: "flex", flexDirection: "column", gap: "4px" }}>
          ...
          {/* Section 3: Royal Gold Scannable QR Code Box (PERFECTLY CENTERED) */}
          <div style={{
            ...
            {qrDataUrl ? (
              <div style={{ display: "flex", flexDirection: "column", alignItems: "center" }}>
                ...
                />
                <div style={{ fontSize: "12.5px", fontWeight: 800, color: "#78350F", marginTop: "6px" }}>
                  {(PAGE7_DICT[code] || PAGE7_DICT.en).qrCaption}
                </div>
              </div>
            ) : (
              <div style={{ padding: "24px", color: "#B45309", fontSize: "13px", fontWeight: 700 }}>
          ...
          <div style={{
            ...
            <div style={{ fontSize: "11.5px", lineHeight: "1.55", color: "#451A03", textAlign: "justify", fontWeight: 600 }}>
