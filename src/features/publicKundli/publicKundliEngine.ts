...
export function generateCustomQuestionAstrologyAnswer(
  ...
  const lord10Localized = GRAHA_NAMES_5L[profile.lord10]?.[lang as PublicKundliLang] || profile.lord10 || "ದಶಮಾಧಿಪತಿ";
  const lord7Localized = GRAHA_NAMES_5L[profile.lord7]?.[lang as PublicKundliLang] || profile.lord7 || "ಸಪ್ತಮಾಧಿಪತಿ";
  const lord5Localized = GRAHA_NAMES_5L[profile.lord5]?.[lang as PublicKundliLang] || profile.lord5 || "ಪಂಚಮಾಧಿಪತಿ";
  const lord6Localized = GRAHA_NAMES_5L[profile.lord6]?.[lang as PublicKundliLang] || profile.lord6 || "ಷಷ್ಠಾಧಿಪತಿ";
  const lagnaSignLocalized = isKn ? profile.lagnaSanskrit : profile.lagnaSign;
  const moonSignLocalized = isKn ? profile.moonSanskrit : profile.moonSign;
  ...
  if (
    ...
    shortVerdict = isKn ? "ಸ್ಥಿರತೆ, ಬಡ್ತಿ ಹಾಗೂ ನವೀನ ಅವಕಾಶಗಳ ಕಾಲ" : "Stability, Promotion & Strategic Professional Inflow";
    auspiciousWindow = isKn ? "ಪ್ರಸ್ತುತ ದಶಾ ಸಂಧಿಕಾಲ ಮುಗಿದು ಮುಂದಿನ ೪ ರಿಂದ ೭ ತಿಂಗಳುಗಳಲ್ಲಿ ಅಧಿಕಾರದ ಉನ್ನತಿ" : "Decisive career breakthrough opening over the next 4 to 7 months";
    ...
    analysisText = isKn
      ? `ನಿಮ್ಮ ಜನ್ಮ ಕುಂಡಲಿಯನ್ನು ಸೂಕ್ಷ್ಮವಾಗಿ ಅವಲೋಕಿಸಿದಾಗ, ನಿಮ್ಮ ${lagnaSignLocalized} ಲಗ್ನಕ್ಕೆ ೧೦ನೇ ಕರ್ಮ ಭಾವ ಮತ್ತು ಕರ್ಮಾಧಿಪತಿಯಾದ ${lord10Localized} ಗ್ರಹದ ಪ್ರಭಾವವು ಅತ್ಯಂತ ಮಹತ್ವದ ಪಾತ್ರವನ್ನು ವಹಿಸುತ್ತದೆ. ಪ್ರಸ್ತುತ ನಡೆಯುತ್ತಿರುವ ${dashaLordLocalized} ಮಹಾದಶೆಯಲ್ಲಿ ${bhuktiLordLocalized} ಭುಕ್ತಿಯ ಸಂಯೋಗವು ನಿಮ್ಮ ಕಾರ್ಯಕ್ಷೇತ್ರದಲ್ಲಿ ನಿರ್ಣಾಯಕ ತಿರುವನ್ನು ತರಲು ಸಜ್ಜಾಗಿದೆ. ನಿಮ್ಮ ಕರ್ಮಸ್ಥಾನದ ಮೇಲೆ ಗ್ರಹಗಳ ಶುಭ ದೃಷ್ಟಿಯು ಹೊಸ ಯೋಜನೆಗಳು, ಸ್ಥಾನಮಾನ ವೃದ್ಧಿ ಮತ್ತು ಉನ್ನತ ಅಧಿಕಾರಿಗಳಿಂದ ಮನ್ನಣೆ ದೊರಕುವ ಪ್ರಬಲ ಸಾಧ್ಯತೆಯನ್ನು ಸೂಚಿಸುತ್ತದೆ. ಈ ಹಿಂದೆ ಉಂಟಾಗಿದ್ದ ವಿಳಂಬ ಅಥವಾ ಅಸ್ಥಿರತೆಗೆ ಗೋಚಾರದಲ್ಲಿ ಶನಿ ಹಾಗೂ ರಾಹುವಿನ ಪ್ರಭಾವ ಕಾರಣವಾಗಿದ್ದು, ಆ ನಕಾರಾತ್ಮಕ ತರಂಗಗಳು ಈಗ ಹಂತಹಂತವಾಗಿ ಕರಗುತ್ತಿವೆ. ನಿಮ್ಮ ಕಾರ್ಯನಿಷ್ಠೆ ಹಾಗೂ ಧೈರ್ಯವು ಈ ಅವಧಿಯಲ್ಲಿ ನಿಮ್ಮನ್ನು ಮುಂಚೂಣಿಗೆ ತರಲಿದೆ.\n\nಮುಂದಿನ ೪ ರಿಂದ ೭ ತಿಂಗಳುಗಳ ಕಾಲಾವಧಿಯು ನೂತನ ಜವಾಬ್ದಾರಿಗಳು, ಉದ್ಯೋಗ ಬದಲಾವಣೆ ಅಥವಾ ವ್ಯಾಪಾರ ವಿಸ್ತರಣೆಗೆ ಅತ್ಯಂತ ಪೂರಕವಾದ ಸುವರ್ಣ ಕಾಲವಾಗಿದೆ. ಆದಾಗ್ಯೂ, ತಾತ್ಕಾಲಿಕವಾಗಿ ಸಹೋದ್ಯೋಗಿಗಳೊಂದಿಗೆ ಯಾವುದೇ ಅಹಂ ಸಂಘರ್ಷಕ್ಕೆ ಇಳಿಯದೆ, ರಾಜತಾಂತ್ರಿಕ ಸಂಯಮವನ್ನು ಕಾಯ್ದುಕೊಳ್ಳುವುದು ನಿಮ್ಮ ದೀರ್ಘಕಾಲಿಕ ಭದ್ರತೆಗೆ ಅತ್ಯಗತ್ಯ. ಆತುರದ ರಾಜೀನಾಮೆ ಅಥವಾ ಅನಿಶ್ಚಿತ ಒಪ್ಪಂದಗಳಿಗೆ ಸಹಿ ಹಾಕುವ ಮುನ್ನ ಜಾಗರೂಕತೆ ವಹಿಸಿ. ಈ ಕಾಲಘಟ್ಟದಲ್ಲಿ ನಿಮ್ಮ ಕಾರ್ಯಕ್ಷೇತ್ರದ ಸಕಲ ಅಡೆತಡೆಗಳನ್ನು ನಿವಾರಿಸಿ ದೈವಿಕ ರಕ್ಷೆ ಪಡೆಯಲು ಶ್ರೀ ಕ್ಷೇತ್ರ ಗೋಕರ್ಣ ಮಹಾಬಲೇಶ್ವರ ಸ್ವಾಮಿಯ ಸನ್ನಿಧಿಯಲ್ಲಿ ಮಹಾರುದ್ರಾಭಿಷೇಕ ಹಾಗೂ ಶ್ರೀ ಮಹಾಗಣಪತಿಗೆ ಅಪ್ಪದ ಕಜ್ಜಾಯ ಸೇವೆ ಸಮರ್ಪಿಸುವುದು ಸಕಲ ವಿಜಯವನ್ನು ತಂದುಕೊಡಲಿದೆ.`
      : `Carefully examining your natal Kundali with ${lagnaSignLocalized} Ascendant, your 10th house of profession (Karma Bhava) and its ruling lord ${lord10Localized} are experiencing a major energetic awakening. Operating under your active ${dashaLordLocalized} Mahadasha and ${bhuktiLordLocalized} Bhukti, celestial forces are converging to bring an authoritative turning point to your vocational journey. The planetary aspects on your midheaven indicate that prolonged delays and unacknowledged diligence from past cycles are now transforming into tangible workplace recognition, elevation, and leadership responsibility. Stagnation caused by recent Saturnian pressure and Rahu-Ketu nodal tension is dissolving, allowing your natural executive competence to be visibly acknowledged by superiors and mentors.\n\nThe upcoming window of 4 to 7 months is exceptionally promising for salary increments, strategic role promotions, or launching autonomous business ventures. To fully capitalize on this auspicious cosmic phase, maintain diplomatic tact, avoid abrupt confrontational debates in workplace politics, and refrain from hasty job changes during minor planetary retrogrades. To dissolve residual karmic resistance and ensure unwavering vocational stability, offering sacred Rudrabhisheka to Lord Mahabaleshwara and Appada Kajjaya Seva to Lord Maha Ganapati at Sri Kshetra Gokarna will channel profound divine protection and professional triumph.`;
  }
  // Marriage / Love / Relationship
    ...
    shortVerdict = isKn ? "ಶುಭ ಕಂಕಣ ಬಲ, ದಾಂಪತ್ಯ ಸಾಮರಸ್ಯ & ಕಲ್ಯಾಣ ಯೋಗ" : "Auspicious Vivaha Yoga, Matrimonial Harmony & Divine Alignment";
    auspiciousWindow = isKn ? "ಮುಂದಿನ ಗುರು ಬಲ ಸಂಚಾರದ ಕಾಲಾವಧಿಯಲ್ಲಿ (೬ ರಿಂದ ೯ ತಿಂಗಳು) ಕಂಕಣ ಬಲ ಸಿದ್ಧಿ" : "Auspicious matrimonial and relational window flourishing over the next 6 to 9 months";
    recommendedGokarnaSeva = isKn
    ...
    analysisText = isKn
      ? `ನಿಮ್ಮ ಜನ್ಮ ಜಾತಕದ ಸಪ್ತಮ ಭಾವ (೭ನೇ ಮನೆ - ಕಳತ್ರ ಹಾಗೂ ಪಾಲುದಾರಿಕೆ ಸ್ಥಾನ) ಮತ್ತು ಸಪ್ತಮಾಧಿಪತಿಯಾದ ${lord7Localized} ಗ್ರಹದ ಸ್ಥಿತಿಯು ದಾಂಪತ್ಯ ಸುಖ ಹಾಗೂ ಸಂಬಂಧಗಳ ಆಳವನ್ನು ನಿರ್ಧರಿಸುತ್ತದೆ. ಪ್ರಸ್ತುತ ನಡೆಯುತ್ತಿರುವ ${dashaLordLocalized} ಮಹಾದಶೆಯಲ್ಲಿ ${bhuktiLordLocalized} ಭುಕ್ತಿಯ ಅವಧಿಯು ನಿಮ್ಮ ಭಾವನಾತ್ಮಕ ಜೀವನದಲ್ಲಿ ಮಹತ್ತರ ಪರಿಪಕ್ವತೆಯನ್ನು ಉಂಟುಮಾಡುತ್ತಿದೆ. ಹಿಂದೆ ಎದುರಾಗಿದ್ದ ಸಂಬಂಧಗಳ ಅಪಾರ್ಥಗಳು, ಕಂಕಣ ಬಲದಲ್ಲಿನ ಅನಗತ್ಯ ವಿಳಂಬಗಳು ಅಥವಾ ಕೌಟುಂಬಿಕ ಮಾತುಕತೆಗಳ ಅಡ್ಡಿಗಳಿಗೆ ಕುಂಡಲಿಯ ಸಪ್ತಮ-ಅಷ್ಟಮ ಭಾವಗಳ ಮೇಲಿನ ತಾತ್ಕಾಲಿಕ ಕ್ರೂರ ದೃಷ್ಟಿಯೇ ಕಾರಣವಾಗಿತ್ತು. ಇದೀಗ ಗೋಚಾರದಲ್ಲಿ ದೇವಗುರು ಬೃಹಸ್ಪತಿಯ ಶುಭ ದೃಷ್ಟಿಯು ಸಪ್ತಮ ಭಾವದ ಮೇಲೆ ಕೇಂದ್ರೀಕೃತವಾಗುತ್ತಿರುವುದರಿಂದ ವಿವಾಹ ಯೋಗವು ಪ್ರಬಲವಾಗಿ ಸಕ್ರಿಯಗೊಳ್ಳುತ್ತಿದೆ.\n\nಮುಂದಿನ ೬ ರಿಂದ ೯ ತಿಂಗಳುಗಳ ಒಳಗೆ ಕಂಕಣ ಬಲ ಪ್ರಾಪ್ತಿಯಾಗಲು, ಯೋಗ್ಯ ಬಾಳಸಂಗಾತಿಯ ಆಗಮನವಾಗಲು ಅಥವಾ ಈಗಾಗಲೇ ದಾಂಪತ್ಯದಲ್ಲಿರುವವರಿಗೆ ಕೌಟುಂಬಿಕ ಶಾಂತಿ ಪುನಃ ಸ್ಥಾಪನೆಯಾಗಲು ಗ್ರಹಗಳು ಸಂಪೂರ್ಣ ಸಾಕ್ಷಿಯಾಗಿವೆ. ಈ ಅವಧಿಯಲ್ಲಿ ಪರಸ್ಪರ ಹೊಂದಾಣಿಕೆ, ಹಳೆಯ ತಪ್ಪುಗ್ರಹಿಕೆಗಳ ನಿವಾರಣೆ ಹಾಗೂ ಕುಟುಂಬದ ಹಿರಿಯರ ಆಶೀರ್ವಾದ ಪಡೆಯಲು ಇದು ಅತ್ಯಂತ ಸಕಾಲ. ದಾಂಪತ್ಯದಲ್ಲಿ ಯಾವುದೇ ದೋಷಗಳಿದ್ದಲ್ಲಿ ಅವುಗಳನ್ನು ಪರಿಹರಿಸಿ, ಅಖಂಡ ಸೌಮಾಂಗಲ್ಯ ಭಾಗ್ಯ ಮತ್ತು ದಾಂಪತ್ಯ ಸುಖವನ್ನು ವೃದ್ಧಿಸಲು ಶ್ರೀ ಕ್ಷೇತ್ರ ಗೋಕರ್ಣದಲ್ಲಿ ಶ್ರೀ ತಾಮ್ರಗೌರಿ ಅಮ್ಮನವರಿಗೆ ಕುಂಕುಮಾರ್ಚನೆ ಹಾಗೂ ಮಂಗಳ ಗೌರಿ ಕಲ್ಯಾಣ ಸಂಕಲ್ಪ ಸೇವೆ ನೆರವೇರಿಸುವುದು ಅತ್ಯಂತ ಶ್ರೇಷ್ಠ ಪರಿಹಾರವಾಗಿದೆ.`
      : `Analyzing your natal chart through the lens of your 7th house of sacred matrimony (Kalatra Bhava) and its ruling lord ${lord7Localized}, alongside Kalatrakaraka Venus and Jupiter, your chart is entering a golden phase of emotional union. Under your active ${dashaLordLocalized} Mahadasha and ${bhuktiLordLocalized} Bhukti, the lingering karmic obstructions that previously caused frustrating delays, mismatched proposals, or relational tension are decisively loosening their grip. Transiting Jupiter is now casting its benevolent 5th/9th trinal aspect toward your partnership axis, energizing your astrological Kankana Bala (matrimonial strength) and paving the way for an authentic, spiritually attuned soul partner.\n\nOver the next 6 to 9 months, highly supportive celestial transits will open fruitful matrimonial negotiations, proposal finalizations, and deep emotional reconciliation for married couples. You are guided to release past heartbreak, cultivate openhearted emotional transparency, and communicate expectations with gentle patience rather than defensive guardedness. To fortify marital longevity and invoke auspicious celestial grace, offering Kumkumarchana to Goddess Tamra Gauri and conducting Mangala Gauri Kalyana Sankalpa at Sri Kshetra Gokarna will bestow lifelong domestic harmony and protective marital sanctity.`;
  }
  // Finance / Wealth / Investment / Debt
    ...
    shortVerdict = isKn ? "ಸ್ಥಿರ ಧನಾಗಮನ, ಸಾಲ ವಿಮೋಚನೆ & ಆಸ್ತಿ ಸಮೃದ್ಧಿಯ ಕಾಲ" : "Steadfast Financial Inflow, Debt Alleviation & Asset Consolidation";
    auspiciousWindow = isKn ? "ಮುಂದಿನ ೪ ರಿಂದ ೮ ತಿಂಗಳುಗಳಲ್ಲಿ ಆರ್ಥಿಕ ಸ್ಥಿತಿಯಲ್ಲಿ ಮಹತ್ತರ ಚೇತರಿಕೆ & ಹೂಡಿಕೆ ಲಾಭ" : "Substantial monetary relief, liquidity recovery and gains in the next 4 to 8 months";
    recommendedGokarnaSeva = isKn
      ? "ಶ್ರೀ ಗೋಕರ್ಣ ಮಹಾಲಕ್ಷ್ಮಿ ಪೂಜೆ ಹಾಗೂ ಕೋಟಿತೀರ್ಥದಲ್ಲಿ ಪವಿತ್ರ ತರ್ಪಣ ಸೇವೆ"
      : "Sri Mahalakshmi Pooja and Kotiteertha holy Tarpana at Gokarna";
    analysisText = isKn
      ? `ನಿಮ್ಮ ಜಾತಕದ ದ್ವಿತೀಯ ಭಾವ (ಧನ ಸ್ಥಾನ), ಏಕಾದಶ ಭಾವ (ಲಾಭ ಸ್ಥಾನ) ಮತ್ತು ಧನಕಾರಕ ಗುರು ಗ್ರಹದ ಸ್ಥಿತಿಯು ನಿಮ್ಮ ಆರ್ಥಿಕ ಪ್ರಗತಿಯ ಅಡಿಪಾಯವಾಗಿದೆ. ಪ್ರಸ್ತುತ ನಡೆಯುತ್ತಿರುವ ${dashaLordLocalized} ಮಹಾದಶೆ ಮತ್ತು ${bhuktiLordLocalized} ಭುಕ್ತಿಯು ನಿಮ್ಮ ಪರಿಶ್ರಮವನ್ನು ಧನರೂಪದಲ್ಲಿ ಪರಿವರ್ತಿಸಲು ನವೀನ ಮಾರ್ಗಗಳನ್ನು ತೆರೆಯುತ್ತಿದೆ. ಈ ಹಿಂದೆ ಎದುರಾದ ಅನಗತ್ಯ ಖರ್ಚುಗಳು, ಅನಿರೀಕ್ಷಿತ ನಷ್ಟಗಳು ಅಥವಾ ಸಾಲದ ಹೊರೆಯು ಕುಂಡಲಿಯ ೧೨ನೇ (ವ್ಯಯ) ಮತ್ತು ೮ನೇ (ಸಂಕಷ್ಟ) ಭಾವಗಳ ಮೇಲಿನ ಅನಿರೀಕ್ಷಿತ ಗ್ರಹ ಸಂಚಾರದಿಂದ ಉಂಟಾಗಿತ್ತು. ಇದೀಗ ಆ ನಕಾರಾತ್ಮಕ ಗ್ರಹ ದೋಷಗಳು ಶಮನಗೊಳ್ಳುತ್ತಿದ್ದು, ಬಾಕಿ ಬರಬೇಕಾದ ಹಣವು ಮರಳಿ ಬರುವ ಹಾಗೂ ಸ್ಥಿರ ಉಳಿತಾಯವು ಹೆಚ್ಚಾಗುವ ಶುಭ ಯೋಗವು ಸೃಷ್ಟಿಯಾಗುತ್ತಿದೆ.\n\nಮುಂದಿನ ೪ ರಿಂದ ೮ ತಿಂಗಳುಗಳ ಕಾಲಾವಧಿಯು ಹೊಸ ಆಸ್ತಿ ಖರೀದಿ, ನ್ಯಾಯಯುತ ಹೂಡಿಕೆಗಳು ಹಾಗೂ ಸಾಲ ಮರುಪಾವತಿಗೆ ಅತ್ಯಂತ ಅನುಕೂಲಕರವಾದ ಕಾಲವಾಗಿದೆ. ಆದರೆ, ಷೇರು ಮಾರುಕಟ್ಟೆ ಅಥವಾ ಅತಿಯಾದ ಆಸೆಯ ಊಹಾತ್ಮಕ ಜೂಜುಗಳಲ್ಲಿ ದುಡುಕಿನ ಹಣ ಹೂಡಿಕೆ ಮಾಡಬಾರದು. ಹಣಕಾಸಿನ ಶಿಸ್ತು ಮತ್ತು ಲೆಕ್ಕಾಚಾರದ ಯೋಜನೆಗಳನ್ನು ಪಾಲಿಸಿದರೆ ಲಕ್ಷ್ಮೀ ಕೃಪೆಯು ನಿರಂತರವಾಗಿ ನೆಲೆಸಲಿದೆ. ಆರ್ಥಿಕ ದಾರಿದ್ರ್ಯ, ಪಿತೃ ಋಣ ಹಾಗೂ ಸಾಲದ ಬಾಧೆಗಳನ್ನು ಬುಡಸಹಿತ ಕಳೆದು ಸಮೃದ್ಧಿ ಪಡೆಯಲು ಶ್ರೀ ಕ್ಷೇತ್ರ ಗೋಕರ್ಣದ ಕೋಟಿತೀರ್ಥದಲ್ಲಿ ಪವಿತ್ರ ಪಿತೃ ತರ್ಪಣ ಮತ್ತು ಶ್ರೀ ಮಹಾಲಕ್ಷ್ಮಿ ಪೂಜಾ ಸಂಕಲ್ಪವನ್ನು ನೆರವೇರಿಸುವುದು ಶಾಶ್ವತ ಧನಲಾಭವನ್ನು ಕರುಣಿಸಲಿದೆ.`
      : `In examining your birth Kundali, your 2nd house of accumulated assets (Dhana Bhava) and 11th house of recurrent profits and gains (Labha Bhava) are directly governed by the transit interplay of Jupiter and Mercury. Operating under the current ${dashaLordLocalized} Mahadasha and ${bhuktiLordLocalized} Bhukti, your financial matrix is entering a stage of constructive stabilization. The preceding cycle of stressful overheads, unrecovered loans, and cash-flow bottlenecks was triggered by 8th/12th house planetary transits. As these obstructive influences clear, your earning potential is regaining its natural velocity, unlocking frozen receivables and rewarding disciplined enterprise.\n\nThe upcoming period across the next 4 to 8 months presents an optimal window for systematic wealth consolidation, clearing long-standing liabilities, and making sound, well-researched capital investments. Avoid high-risk speculative trading or lending funds without legal documentation during this transitional phase. To neutralize ancestral financial encumbrances (Rina Dosha) and invite everlasting abundance into your household, sponsoring Sri Mahalakshmi Pooja and offering sacred Tarpana at Kotiteertha in Gokarna will clear financial stagnations and anchor enduring wealth.`;
  }
  // Health / Illness / Peace of Mind
    ...
    shortVerdict = isKn ? "ದೈಹಿಕ ಚೈತನ್ಯ ಪುನರುಜ್ಜೀವನ, ರೋಗ ನಿವಾರಣೆ & ಮಾನಸಿಕ ನೆಮ್ಮದಿ" : "Restoration of Vital Energy, Cellular Healing & Deep Peace";
    auspiciousWindow = isKn ? "ಮುಂದಿನ ೨ ರಿಂದ ೫ ತಿಂಗಳುಗಳಲ್ಲಿ ಪರಿಪೂರ್ಣ ಆರೋಗ್ಯ ಸುಧಾರಣೆ & ಆತಂಕ ಶಮನ" : "Progressive healing, physical rejuvenation and mental tranquility within 2 to 5 months";
    recommendedGokarnaSeva = isKn
      ? "ಶ್ರೀ ಕ್ಷೇತ್ರ ಗೋಕರ್ಣದಲ್ಲಿ ಮಹಾ ಮೃತ್ಯುಂಜಯ ಹೋಮ ಹಾಗೂ ಆಯುಷ್ಯ ಸೂಕ್ತ ಹವನ"
      : "Maha Mrityunjaya Homa & Ayushya Sukta Havanam at Gokarna";
    analysisText = isKn
      ? `ನಿಮ್ಮ ಜನ್ಮ ಕುಂಡಲಿಯಲ್ಲಿ ಲಗ್ನ ಸ್ಥಾನ (ದೇಹ & ಜೀವಶಕ್ತಿ), ೬ನೇ ಭಾವ (ರೋಗ-ರುಜಿನಗಳ ಸ್ಥಾನ) ಮತ್ತು ಲಗ್ನಾಧಿಪತಿಯಾದ ${lagnaLordLocalized} ಗ್ರಹದ ಬಲವು ನಿಮ್ಮ ಆರೋಗ್ಯ ಹಾಗೂ ಮಾನಸಿಕ ಸ್ಥೈರ್ಯವನ್ನು ನಿಯಂತ್ರಿಸುತ್ತದೆ. ಪ್ರಸ್ತುತ ನಡೆಯುತ್ತಿರುವ ${dashaLordLocalized} ಮಹಾದಶೆ ಮತ್ತು ${bhuktiLordLocalized} ಭುಕ್ತಿಯ ಅವಧಿಯಲ್ಲಿ ದೇಹದಲ್ಲಿ ಶಕ್ತಿಯ ಕೊರತೆ, ನಿದ್ರಾಹೀನತೆ ಅಥವಾ ಸಣ್ಣ ವಿಷಯಗಳಿಗೂ ಮಾನಸಿಕ ಆತಂಕ ಕಾಡುತ್ತಿರಬಹುದು. ನಿಮ್ಮ ಜಾತಕದಲ್ಲಿ ಮಾಂದಿ ಗ್ರಹವು ${profile.maandiHouse}ನೇ ಮನೆಯಲ್ಲಿ ಇರುವುದರಿಂದ ನರ ದೌರ್ಬಲ್ಯ, ಹೊಟ್ಟೆಯ ಸಮಸ್ಯೆಗಳು ಅಥವಾ ಮನಸ್ಸಿನಲ್ಲಿ ಅಕಾರಣ ಭಯ ಉಂಟಾಗುವುದು ಸಹಜ. ಆದರೆ, ಲಗ್ನಾಧಿಪತಿಯ ನೈಸರ್ಗಿಕ ಶುಭ ಬಲವು ನಿಮ್ಮ ರೋಗನಿರೋಧಕ ಶಕ್ತಿಯನ್ನು ಮತ್ತೆ ಜಾಗೃತಗೊಳಿಸುತ್ತಿದೆ.\n\nಮುಂದಿನ ೨ ರಿಂದ ೫ ತಿಂಗಳುಗಳ ಅವಧಿಯಲ್ಲಿ ನಿಮ್ಮ ದೇಹದ ಸಕಲ ರೋಗ-ಉಪದ್ರವಗಳು ಶಮನಗೊಂಡು, ಮುಖದಲ್ಲಿ ತೇಜಸ್ಸು ಹಾಗೂ ಮನಸ್ಸಿನಲ್ಲಿ ಅಚಲ ಪ್ರಶಾಂತತೆ ಮರಳಿ ಬರಲಿದೆ. ಪ್ರಾತಃಕಾಲ ಸೂರ್ಯ ನಮಸ್ಕಾರ, ಸಾತ್ವಿಕ ಆಹಾರ ಪದ್ಧತಿ ಹಾಗೂ ಧ್ಯಾನವನ್ನು ದಿನಚರಿಯಲ್ಲಿ ಅಳವಡಿಸಿಕೊಳ್ಳುವುದು ದೈಹಿಕ ಸಮತೋಲನಕ್ಕೆ ರಾಮಬಾಣ. ದೀರ್ಘಕಾಲಿಕ ಕಾಯಿಲೆಗಳು, ಅಕಾಲಿಕ ಭಯ ಹಾಗೂ ಸಮಸ್ತ ಆಧಿ-ವ್ಯಾಧಿಗಳನ್ನು ನಿವಾರಿಸಲು ಶ್ರೀ ಕ್ಷೇತ್ರ ಗೋಕರ್ಣ ಮಹಾಬಲೇಶ್ವರ ಸನ್ನಿಧಿಯಲ್ಲಿ ಮಹಾ ಮೃತ್ಯುಂಜಯ ಹೋಮ ಹಾಗೂ ಆಯುಷ್ಯ ಸೂಕ್ತ ಹವನವನ್ನು ನೆರವೇರಿಸುವುದು ನಿಮಗೆ ದೀರ್ಘಾಯುಷ್ಯ ಮತ್ತು ಪರಿಪೂರ್ಣ ಆರೋಗ್ಯವನ್ನು ದಯಪಾಲಿಸಲಿದೆ.`
      : `Your natal Kundali evaluates physical wellness and vitality through your 1st house of life-force (Tanu Bhava), ruled by ${lagnaLordLocalized}, alongside your 6th house of illness and metabolic balance (Roga Bhava) governed by ${lord6Localized}. Under the active sway of ${dashaLordLocalized} Mahadasha and ${bhuktiLordLocalized} Bhukti, your physical system has been absorbing accumulated nervous fatigue, sleep disruption, and subconscious anxiety. The positioning of Maandi in house ${profile.maandiHouse} and planetary transits contributed to periodic digestion sensitivity, muscular tightness, or psychosomatic restlessness. Fortunately, your Ascendant's inherent resilience is initiating a powerful restorative counter-wave.\n\nOver the next 2 to 5 months, holistic vitality and mental serenity will steadily consolidate, restoring balanced sleep cycles, emotional lightness, and renewed cellular energy. You are strongly advised to synchronize daily routines with Ayurvedic rhythms: engaging in gentle pranayama at sunrise, maintaining clean hydration, and taking a mindful digital pause before nightfall. To permanently dissolve lingering health vulnerabilities, pacify planetary affliction, and secure radiant longevity, participating in Maha Mrityunjaya Homa and Ayushya Sukta Havanam at Sri Kshetra Gokarna will envelop you in profound divine vitality.`;
  }
  // Children / Education / Future
    ...
    shortVerdict = isKn ? "ವಿದ್ಯಾ ಪ್ರಗತಿ, ಸ್ಪರ್ಧಾತ್ಮಕ ಜಯ & ಸುಪುತ್ರ-ಪುತ್ರಿ ಭಾಗ್ಯೋದಯ" : "Academic Brilliance, Examination Triumph & Sacred Progeny Blessings";
    auspiciousWindow = isKn ? "ಮುಂದಿನ ೪ ರಿಂದ ೭ ತಿಂಗಳುಗಳಲ್ಲಿ ಶೈಕ್ಷಣಿಕ ಮನ್ನಣೆ ಹಾಗೂ ಸಂತಾನ ಯೋಗ ಸಿದ್ಧಿ" : "Optimal academic laurels and auspicious progeny window unfolding within 4 to 7 months";
    recommendedGokarnaSeva = isKn
    ...
    analysisText = isKn
      ? `ನಿಮ್ಮ ಜನ್ಮ ಜಾತಕದ ಪಂಚಮ ಭಾವ (೫ನೇ ಮನೆ - ಬುದ್ಧಿ, ಜ್ಞಾನ & ಸಂತಾನ ಸ್ಥಾನ) ಮತ್ತು ಪಂಚಮಾಧಿಪತಿಯಾದ ${lord5Localized} ಗ್ರಹದ ಜೊತೆಗೆ ವಿದ್ಯಾ-ಸಂತಾನಕಾರಕ ಗುರು ಬೃಹಸ್ಪತಿಯ ಅನುಗ್ರಹವು ನಿಮ್ಮ ಬಾಳಿನ ಪೂರ್ವಪುಣ್ಯವನ್ನು ಪ್ರತಿಬಿಂಬಿಸುತ್ತದೆ. ಪ್ರಸ್ತುತ ನಡೆಯುತ್ತಿರುವ ${dashaLordLocalized} ಮಹಾದಶೆ ಮತ್ತು ${bhuktiLordLocalized} ಭುಕ್ತಿಯು ಜ್ಞಾನಾರ್ಜನೆ, ಸ್ಪರ್ಧಾತ್ಮಕ ಪರೀಕ್ಷೆಗಳಲ್ಲಿ ಯಶಸ್ಸು ಹಾಗೂ ಕುಟುಂಬದಲ್ಲಿ ಸಂತಾನ ಸೌಖ್ಯವನ್ನು ವೃದ್ಧಿಸಲು ಅತ್ಯಂತ ಪೂರಕವಾಗಿದೆ. ಈ ಹಿಂದೆ ವಿದ್ಯಾಭ್ಯಾಸದಲ್ಲಿ ಏಕಾಗ್ರತೆಯ ಕೊರತೆ, ಪರೀಕ್ಷಾ ಆತಂಕ ಅಥವಾ ಸಂತಾನ ಅಪೇಕ್ಷಿಗಳಿಗೆ ಉಂಟಾಗಿದ್ದ ವಿಳಂಬಗಳಿಗೆ ಕುಂಡಲಿಯ ಪಂಚಮ ಸ್ಥಾನದ ಮೇಲಿನ ರಾಹು-ಕೇತುಗಳ ಅಥವಾ ಶನಿಯ ತಾತ್ಕಾಲಿಕ ಛಾಯೆಯೇ ಕಾರಣವಾಗಿತ್ತು. ಆ ದೋಷಗಳ ಪ್ರಭಾವವು ಈಗ ತಗ್ಗುತ್ತಿದ್ದು, ಶುಭ ಕಾಲವು ಪ್ರಾರಂಭವಾಗಿದೆ.\n\nಮುಂದಿನ ೪ ರಿಂದ ೭ ತಿಂಗಳುಗಳ ಅವಧಿಯು ವಿದ್ಯಾರ್ಥಿಗಳಿಗೆ ಉನ್ನತ ಶ್ರೇಣಿಯ ಅಂಕಗಳು, ಮೆರಿಟ್ ಸೀಟು ಅಥವಾ ಉನ್ನತ ವಿದ್ಯಾಭ್ಯಾಸದ ಪ್ರವೇಶ ಪಡೆಯಲು ಅತ್ಯುನ್ನತ ಯೋಗವನ್ನು ತರಲಿದೆ. ಅಂತೆಯೇ, ಸಂತತಿಗಾಗಿ ಪ್ರಾರ್ಥಿಸುತ್ತಿರುವ ದಂಪತಿಗಳಿಗೆ ದೈವಾನುಗ್ರಹದಿಂದ ಶುಭ ವಾರ್ತೆ ಲಭಿಸುವ ಪವಿತ್ರ ಕಾಲಚಕ್ರವು ಸನ್ನಿಹಿತವಾಗಿದೆ. ನಿಮ್ಮ ಬುದ್ಧಿಶಕ್ತಿಯನ್ನು ಸೃಜನಾತ್ಮಕವಾಗಿ ಬಳಸಿಕೊಂಡು, ಆತ್ಮವಿಶ್ವಾಸದಿಂದ ಮುನ್ನಡೆಯಿರಿ. ವಿದ್ಯೆಯಲ್ಲಿ ಸದಾ ಪ್ರಥಮ ಸ್ಥಾನ ಹಾಗೂ ಸಂತಾನ ಸೌಭಾಗ್ಯಕ್ಕಾಗಿ ಶ್ರೀ ಕ್ಷೇತ್ರ ಗೋಕರ್ಣದಲ್ಲಿ ಶ್ರೀ ಮಹಾಗಣಪತಿ ಸನ್ನಿಧಿಯಲ್ಲಿ ಸರಸ್ವತೀ ಹೋಮ ಹಾಗೂ ಸಂತಾನ ಗೋಪಾಲ ಮಂತ್ರಾನುಷ್ಠಾನ ಪೂಜೆಯನ್ನು ನೆರವೇರಿಸುವುದು ನಿಮ್ಮ ಸಕಲ ಆಶಯಗಳನ್ನು ಸಿದ್ಧಿಗೊಳಿಸಲಿದೆ.`
      : `Your birth Kundali addresses intellectual brilliance, examination mastery, and child blessings through your 5th house of Poorva Punya, ruled by ${lord5Localized}, and fortified by Putrakaraka and Vidyakaraka Jupiter. Operating under the current ${dashaLordLocalized} Mahadasha and ${bhuktiLordLocalized} Bhukti, cosmic intelligence is directly activating your creative cognition and academic potential. The prior phase of wandering mental focus, examination anxiety, or prolonged longing for parenthood was exacerbated by karmic nodal aspects upon your 5th house axis. As these malefic rays dissipate, the intrinsic spiritual and intellectual merit of your chart is ascending into prominence.\n\nThe forthcoming 4 to 7 months herald a remarkably fertile window for competitive examinations, high-ranking admissions, scholarship acquisitions, and auspicious progeny blessings. Students are encouraged to maintain disciplined memory routines, minimize digital fragmentation, and channel focused intellect. Couples praying for healthy progeny will find celestial timing exceptionally supportive for conception. To empower scholastic brilliance and remove hurdles in progeny fulfillment, conducting Sri Saraswati Homa and Santana Gopala Mantranushtana at Sri Kshetra Gokarna will awaken supreme intellectual illumination and bless your lineage with joy.`;
  }
  // General / Spiritual
  else {
    category = "general";
    categoryLocalized = isKn ? "ಸಾಮಾನ್ಯ ಜೀವನ & ಕಾಲಚಕ್ರ" : "General Life & Timeline Guidance";
    shortVerdict = isKn ? "ಕರ್ಮ ಪರಿಪಕ್ವತೆ, ದೈವಾನುಗ್ರಹ & ಸರ್ವತೋಮುಖ ಕಾರ್ಯಸಿದ್ಧಿ" : "Karmic Resolution, Divine Alignment & Holistic Fulfillment";
    auspiciousWindow = isKn ? "ಮುಂದಿನ ೩ ರಿಂದ ೬ ತಿಂಗಳುಗಳಲ್ಲಿ ಸಕಾರಾತ್ಮಕ ಪರಿವರ್ತನೆ & ದೈವಿಕ ರಕ್ಷೆ" : "Decisive positive transition and divine grace manifesting over the next 3 to 6 months";
    recommendedGokarnaSeva = isKn
      ? "ಶ್ರೀ ಕ್ಷೇತ್ರ ಗೋಕರ್ಣ ಮಹಾಬಲೇಶ್ವರ ಸ್ವಾಮಿಗೆ ಮಹಾರುದ್ರಾಭಿಷೇಕ ಹಾಗೂ ಶ್ರೀ ಮಹಾಗಣಪತಿಗೆ ಅಪ್ಪದ ಕಜ್ಜಾಯ ಸೇವೆ"
      : "Sri Gokarna Mahabaleshwara Mahadrudrabhisheka & Maha Ganapati Seva";
    analysisText = isKn
      ? `ನಿಮ್ಮ ಜನ್ಮ ಜಾತಕವನ್ನು ಸಮಗ್ರವಾಗಿ ವಿಶ್ಲೇಷಿಸಿದಾಗ, ನಿಮ್ಮ ${lagnaSignLocalized} ಲಗ್ನ, ${moonSignLocalized} ರಾಶಿ ಮತ್ತು ಲಗ್ನಾಧಿಪತಿಯಾದ ${lagnaLordLocalized} ಗ್ರಹದ ಸ್ಥಾನವು ನಿಮಗೆ ದೈವದತ್ತವಾದ ಆಂತರಿಕ ಶಕ್ತಿ ಮತ್ತು ಧಾರ್ಮಿಕ ಮಾರ್ಗವನ್ನು ನೀಡಿದೆ. ಪ್ರಸ್ತುತ ನಡೆಯುತ್ತಿರುವ ${dashaLordLocalized} ಮಹಾದಶೆಯಲ್ಲಿ ${bhuktiLordLocalized} ಭುಕ್ತಿಯ ಕಾಲಘಟ್ಟವು ನಿಮ್ಮ ಜೀವನದ ಪ್ರಮುಖ ಕರ್ಮಿಕ ಪರಿವರ್ತನೆಗೆ ಸಾಕ್ಷಿಯಾಗಿದೆ. ನಿಮ್ಮ ಜಾತಕದ ಕೇಂದ್ರ (೧, ೪, ೭, ೧೦) ಮತ್ತು ತ್ರಿಕೋಣ (೧, ೫, ೯) ಸ್ಥಾನಗಳ ಬಲವು ನಿಮ್ಮನ್ನು ಸಂಕಷ್ಟಗಳ ಸುಳಿಯಿಂದ ರಕ್ಷಿಸಿ, ಗೌರವಯುತ ಸ್ಥಾನಕ್ಕೆ ಕೊಂಡೊಯ್ಯುವ ಶಕ್ತಿಯನ್ನು ಹೊಂದಿದೆ. ಪ್ರಸ್ತುತ ಎದುರಾಗುತ್ತಿರುವ ಸಣ್ಣಪುಟ್ಟ ಗೊಂದಲಗಳು ಅಥವಾ ಸವಾಲುಗಳು ನಿಮ್ಮ ಆತ್ಮವನ್ನು ಪಕ್ವಗೊಳಿಸಲು ಬಂದಿರುವ ತಾತ್ಕಾಲಿಕ ಪರೀಕ್ಷೆಗಳಾಗಿದ್ದು, ಶಾಶ್ವತ ಅಡೆತಡೆಗಳಲ್ಲ.\n\nಮುಂದಿನ ೩ ರಿಂದ ೬ ತಿಂಗಳುಗಳ ಕಾಲಾವಧಿಯು ನಿಮ್ಮ ದೈನಂದಿನ ಜೀವನದಲ್ಲಿ ನವೀನ ಸಕಾರಾತ್ಮಕ ಬದಲಾವಣೆಗಳು, ಮಾನಸಿಕ ನೆಮ್ಮದಿ ಹಾಗೂ ಸ್ಥಗಿತಗೊಂಡಿದ್ದ ಕಾರ್ಯಗಳು ವೇಗವಾಗಿ ಪೂರ್ಣಗೊಳ್ಳುವ ಕಾಲವನ್ನು ತರಲಿದೆ. ಧರ್ಮ ಮತ್ತು ಸತ್ಯದ ಹಾದಿಯಲ್ಲಿ ದೃಢವಾಗಿ ನಿಂತು, ಧೈರ್ಯದಿಂದ ಮುನ್ನಡೆಯುವುದು ನಿಮ್ಮ ಏಳಿಗೆಗೆ ಮೂಲ ಮಂತ್ರ. ನಿಮ್ಮ ಕುಂಡಲಿಯ ಸಮಸ್ತ ಗ್ರಹ ದೋಷಗಳನ್ನು ಶಮನಗೊಳಿಸಿ, ಕುಟುಂಬದಲ್ಲಿ ಸುಖ-ಶಾಂತಿ ಹಾಗೂ ಸಕಲ ಕಾರ್ಯಗಳಲ್ಲಿ ನಿರಂತರ ಜಯವನ್ನು ಸಾಧಿಸಲು ಶ್ರೀ ಕ್ಷೇತ್ರ ಗೋಕರ್ಣದ ಪವಿತ್ರ ಆತ್ಮಲಿಂಗ ಸ್ವರೂಪಿ ಮಹಾಬಲೇಶ್ವರ ಸ್ವಾಮಿಗೆ ಮಹಾರುದ್ರಾಭಿಷೇಕ ಹಾಗೂ ದ್ವಿಮುಖ ಮಹಾಗಣಪತಿಗೆ ಅಪ್ಪದ ಕಜ್ಜಾಯ ಸೇವೆ ಸಮರ್ಪಿಸುವುದು ಶ್ರೇಷ್ಠ ದೈವಿಕ ರಕ್ಷೆಯಾಗಿದೆ.`
      : `Evaluating your holistic natal matrix featuring ${lagnaSignLocalized} Ascendant and ${moonSignLocalized} Moon, under the sovereign custodianship of your Lagna Lord ${lagnaLordLocalized}, your chart reveals strong dharmic resilience and deep soul wisdom. Under the active reign of your ${dashaLordLocalized} Mahadasha and ${bhuktiLordLocalized} Bhukti, your life is passing through a watershed cycle of karmic maturation. The supportive planetary pillars of your Kendra (quadrant) and Trikona (trine) houses are shielding you against structural downfall, transmuting apparent obstacles into pivotal stepping stones for character and spiritual fortitude. The friction you have recently encountered is not a setback, but an essential cosmic refinement preparing you for a broader life platform.\n\nOver the next 3 to 6 months, you will witness tangible breakthroughs across your personal endeavors, with delayed enterprises regaining momentum and profound clarity replacing past ambivalence. You are guided to anchor your everyday decisions in moral courage, preserve authentic compassion, and refuse to let external cynicism dictate your inner peace. To harmonize all planetary frequencies and invoke the supreme blessings of Sri Kshetra Gokarna, offering sacred Atma Linga Mahadrudrabhisheka to Lord Mahabaleshwara and Appada Kajjaya Seva to Lord Maha Ganapati will manifest all-round victory, auspicious prosperity, and divine tranquility.`;
  }
