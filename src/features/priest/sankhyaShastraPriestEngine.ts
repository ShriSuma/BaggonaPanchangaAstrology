  ...
  const fallbackParagraphs = [
    {
      ...
      contentKn: `ನೀವು ಕೇಳಿರುವ ಪ್ರಶ್ನೆಗೆ ("${question}"), ಆಯ್ಕೆಮಾಡಲಾದ ಸಂಖ್ಯೆ ${number} ರ ಅಧಿಪತಿಯಾದ ${planet.nameKn} ಶುಭ ಸ್ಥಾನದಲ್ಲಿದ್ದು, ನೇರ ಶುಭ ಫಲವನ್ನು ನೀಡುತ್ತಿದೆ. ಈ ಪ್ರಶ್ನೆಯ ಪ್ರಕೃತಿಯು '${planet.nature}' ಆಗಿದೆ. ನಿಮ್ಮ ಸಂಕಲ್ಪವು ಕಾಲಾನುಗುಣವಾಗಿ ಈಡೇರಲಿದ್ದು, ಯಾವುದೇ ರೀತಿಯ ಗೊಂದಲಗಳಿಗೆ ಒಳಗಾಗಬೇಕಾಗಿಲ್ಲ.`
    },
    {
...
ಬಹಳ ಮುಖ್ಯ ನಿಯಮ: ಭಕ್ತರು ಕೇಳಿರುವ ಪ್ರಶ್ನೆಗೆ ("${question}") ನೇರ, ನಿಖರ ಹಾಗೂ ಸ್ಪಷ್ಟ ಉತ್ತರವನ್ನು ಮೊದಲ ವಾಕ್ಯದಲ್ಲೇ ನೀಡಿ.
ದಯವಿಟ್ಟು ಈ ಪ್ರಶ್ನೆಗೆ ನಿಖರವಾದ ೪ ಪ್ಯಾರಾಗ್ರಾಫ್‌ಗಳ ತಾಂತ್ರಿಕ ಸಂಖ್ಯಾಶಾಸ್ತ್ರ ವಿವರಣೆಯನ್ನು ಶುದ್ಧ ಕನ್ನಡದಲ್ಲಿ ಮಾತ್ರ ನೀಡಿ:
ಪ್ಯಾರಾಗ್ರಾಫ್ ೧: ನೇರ ನಿರ್ಣಯ ಮತ್ತು ಸಂಖ್ಯಾ ಗ್ರಹ ಪ್ರಭಾವ (ಭಕ್ತರ ಪ್ರಶ್ನೆಗೆ ನೇರ ಉತ್ತರ)
