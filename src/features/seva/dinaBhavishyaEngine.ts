...
export const CHANDRA_BALA_RULES: Record<number, Record<SevaLang, { title: string; desc: string; isFavorable: boolean }>> = {
  1: {
    kn: { title: "ಜನ್ಮ ಚಂದ್ರ (೧ನೇ ಭಾವ - ಆತ್ಮ ಬಲ)", desc: "ಆತ್ಮವಿಶ್ವಾಸ, ಗೌರವ ಹಾಗೂ ನಾಯಕತ್ವ ವೃದ್ಧಿ. ದಿನವಿಡೀ ಹೊಸ ಉತ್ಸಾಹ ಹಾಗೂ ಕಾರ್ಯಕ್ಷೇತ್ರದಲ್ಲಿ ನವ ಚೈತನ್ಯ.", isFavorable: true },
    en: { title: "Janma Chandra (1st House - Self Vitality)", desc: "High confidence, personal authority, and physical vitality. Excellent day for setting self-goals.", isFavorable: true },
    hi: { title: "जन्म चंद्र (प्रथम भाव - आत्म बल)", desc: "शारीरिक स्वास्थ्य, मान-सम्मान एवं मानसिक उत्साह। शुभ कार्यों के लिए उत्तम।", isFavorable: true },
    te: { title: "జన్మ చంద్రుడు (1వ భావం - ఆత్మ బలం)", desc: "శరీర సౌఖ్యం, గౌరవం మరియు మానసిక ఉత్సాహం. కొత్త పనులకు అనుకూలం.", isFavorable: true },
    ta: { title: "ஜன்ம சந்திரன் (1ம் பாவம் - ஆன்ம பலம்)", desc: "உடல் சௌக்கியம், மரியாதை மற்றும் மன உற்சாகம். புதிய முயற்சிகளுக்கு சாதகம்.", isFavorable: true }
  },
  2: {
    kn: { title: "ದ್ವಿತೀಯ ಚಂದ್ರ (೨ನೇ ಭಾವ - ಧನ ಕೋಶ)", desc: "ಆರ್ಥಿಕ ವ್ಯವಹಾರಗಳಲ್ಲಿ ಜಾಗ್ರತೆ ಅಗತ್ಯ. ಹಠಾತ್ ಖರ್ಚುಗಳ ಮೇಲೆ ನಿಯಂತ್ರಣವಿರಲಿ; ಕುಟುಂಬದಲ್ಲಿ ಮೃದು ಮಾತು ಕ್ಷೇಮ.", isFavorable: false },
    en: { title: "2nd House Chandra (Treasury & Speech)", desc: "Prudent fiscal management required. Control impulsive family expenses and speak diplomatically.", isFavorable: false },
    hi: { title: "द्वितीय चंद्र (2रा भाव - धन कोष)", desc: "आर्थिक लेन-देन में सतर्कता आवश्यक। वाणी पर संयम रखें और अनावश्यक खर्च से बचें।", isFavorable: false },
    te: { title: "ద్వితీయ చంద్రుడు (2వ భావం - ధన స్థానం)", desc: "ఆర్థిక లావాదేవీలలో జాగ్రత్త అవసరం. సంభాషణలలో సంయమనం పాటించండి.", isFavorable: false },
    ta: { title: "இரண்டாம் பாவம் சந்திரன் (தன ஸ்தானம்)", desc: "பணப் பரிவர்த்தனைகளில் கவனம் தேவை. பேச்சில் நிதானம் காக்கவும்.", isFavorable: false }
  },
  3: {
    kn: { title: "ತೃತೀಯ ಚಂದ್ರ (೩ನೇ ಭಾವ - ಪರಾಕ್ರಮ & ಜಯ)", desc: "ಕಾರ್ಯ ಜಯ, ಧನ ಲಾಭ, ಸಾಹಸ ಮನೋಭಾವ ಹಾಗೂ ಸಹೋದರ-ಮಿತ್ರರ ಸಂಪೂರ್ಣ ಬೆಂಬಲ. ಮಹಾ ಶುಭ ಯೋಗ.", isFavorable: true },
    en: { title: "3rd House Chandra (Valor & Victory)", desc: "Supreme victory in efforts, financial expansion, fearless initiative, and peer support.", isFavorable: true },
    hi: { title: "तृतीय चंद्र (3रा भाव - पराक्रम व विजय)", desc: "कार्यों में विजय, धन लाभ, पराक्रम वृद्धि एवं मित्रों का पूर्ण सहयोग। अति शुभ।", isFavorable: true },
    te: { title: "తృతీయ చంద్రుడు (3వ భావం - పరాక్రమం)", desc: "కార్య విజయం, ధన లాభం, ధైర్యం మరియు బంధుమిత్రుల సహకారం. మహా శుభం.", isFavorable: true },
    ta: { title: "மூன்றாம் பாவம் சந்திரன் (வெற்றி யோகம்)", desc: "காரிய வெற்றி, பண வரவு, தைரியம் மற்றும் நண்பர்களின் ஆதரவு. மிகவும் சுபம்.", isFavorable: true }
  },
  4: {
    kn: { title: "ಚತುರ್ಥ ಚಂದ್ರ (೪ನೇ ಭಾವ - ಸುಖ & ಮಾತೃ ಸ್ಥಾನ)", desc: "ಮನಸ್ಸಿನಲ್ಲಿ ಸಣ್ಣಪುಟ್ಟ ಚಂಚಲತೆ, ಗೃಹ ಅಥವಾ ವಾಹನ ಸಂಬಂಧಿ ಖರ್ಚು. ಶಾಂತಚಿತ್ತದಿಂದ ದಿನ ಕಳೆಯುವುದು ಶ್ರೇಷ್ಠ.", isFavorable: false },
    en: { title: "4th House Chandra (Home & Emotion)", desc: "Emotional sensitivity or property/vehicle maintenance. Avoid unnecessary domestic debates.", isFavorable: false },
    hi: { title: "चतुर्थ चंद्र (4था भाव - सुख स्थान)", desc: "घरेलू मामलों में धैर्य रखें। मानसिक शांति बनाए रखने के लिए ध्यान करें।", isFavorable: false },
    te: { title: "చతుర్థ చంద్రుడు (4వ భావం - సుఖ స్థానం)", desc: "గృహ వ్యవహారాలలో ప్రశాంతత అవసరం. నిర్ణయాలలో తొందరపాటు వద్దు.", isFavorable: false },
    ta: { title: "நான்காம் பாவம் சந்திரன் (சுக ஸ்தானம்)", desc: "மன அமைதி காக்கவும். அவசர முடிவுகளைத் தவிர்க்கவும்.", isFavorable: false }
  },
  5: {
    kn: { title: "ಪಂಚಮ ಚಂದ್ರ (೫ನೇ ಭಾವ - ಬುದ್ಧಿ & ಪೂರ್ವಪುಣ್ಯ)", desc: "ಬೌದ್ಧಿಕ ಯೋಜನೆಗಳಲ್ಲಿ ತೀಕ್ಷ್ಣತೆ. ಆತುರದ ಹೂಡಿಕೆಗಳು ಬೇಡ; ಮಕ್ಕಳ ಮಾರ್ಗದರ್ಶನ ಹಾಗೂ ದೇವತೋಪಾಸನೆಗೆ ಪ್ರಶಸ್ತ.", isFavorable: false },
    en: { title: "5th House Chandra (Intellect & Foresight)", desc: "Sharp creative insights. Avoid speculative investments; focus on spiritual study and children's welfare.", isFavorable: false },
    hi: { title: "पंचम चंद्र (5वां भाव - बुद्धि व संतान)", desc: "जल्दबाजी में वित्तीय निर्णय न लें। बच्चों के मार्गदर्शन और बौद्धिक कार्यों पर ध्यान दें।", isFavorable: false },
    te: { title: "పంచమ చంద్రుడు (5వ భావం - బుద్ధి స్థానం)", desc: "ఆలోచించి నిర్ణయాలు తీసుకోండి. పిల్లల శ్రేయస్సుపై శ్రద్ధ వహించండి.", isFavorable: false },
    ta: { title: "ஐந்தாம் பாவம் சந்திரன் (புத்தி ஸ்தானம்)", desc: "யோசித்து முடிவெடுக்கவும். புத்திசாலித்தனமான திட்டமிடல் தேவை.", isFavorable: false }
  },
  6: {
    kn: { title: "ಷಷ್ಠ ಚಂದ್ರ (೬ನೇ ಭಾವ - ಶತ್ರು ಜಯ & ರೋಗ ಮುಕ್ತಿ)", desc: "ಎದುರಾಳಿಗಳ ಮೇಲೆ ಸಂಪೂರ್ಣ ಜಯ, ದೈಹಿಕ ಆರೋಗ್ಯ ಚೇತರಿಕೆ, ಹಳೆಯ ಸಾಲ ವಿಮುಕ್ತಿ ಹಾಗೂ ಕಾರ್ಯ ಸಫಲತೆ.", isFavorable: true },
    en: { title: "6th House Chandra (Victory & Healing)", desc: "Decisive victory over competition, relief from chronic ailments, debt reduction, and dynamic success.", isFavorable: true },
    hi: { title: "षष्ठ चंद्र (6ठा भाव - शत्रु विजय)", desc: "शत्रु विजय, स्वास्थ्य लाभ, पुरानी समस्याओं से मुक्ति एवं कार्यों में सफलता।", isFavorable: true },
    te: { title: "షష్ట చంద్రుడు (6వ భావం - రోగ విముక్తి)", desc: "ఆరోగ్య మెరుగుదల, శత్రు జయం మరియు పనులలో చక్కని పురోగతి.", isFavorable: true },
    ta: { title: "ஆறாம் பாவம் சந்திரன் (ரோக நிவாரணம்)", desc: "சுகாதார முன்னேற்றம், தடைகள் நீங்குதல் மற்றும் காரிய வெற்றி.", isFavorable: true }
  },
  7: {
    kn: { title: "ಸಪ್ತಮ ಚಂದ್ರ (೭ನೇ ಭಾವ - ಕಳತ್ರ & ಸೌಹಾರ್ದ)", desc: "ದಾಂಪತ್ಯ ಸುಖ, ವ್ಯಾಪಾರ ಪಾಲುದಾರಿಕೆಯಲ್ಲಿ ಲಾಭ, ಆಹ್ಲಾದಕರ ಪ್ರಯಾಣ ಹಾಗೂ ಸಮಾಜದಲ್ಲಿ ಸಾರ್ವಜನಿಕ ಗೌರವ.", isFavorable: true },
    en: { title: "7th House Chandra (Partnership & Harmony)", desc: "Marital tenderness, profitable business agreements, fruitful journeys, and social goodwill.", isFavorable: true },
    hi: { title: "सप्तम चंद्र (7वां भाव - दांपत्य व लाभ)", desc: "वैवाहिक सुख, व्यापारिक लाभ, सुखद यात्रा एवं समाज में प्रतिष्ठा वृद्धि।", isFavorable: true },
    te: { title: "సప్తమ చంద్రుడు (7వ భావం - కళత్ర స్థానం)", desc: "దాంపత్య సుఖం, వ్యాపార లాభం మరియు సంతోషకరమైన ప్రయాణం.", isFavorable: true },
    ta: { title: "ஏழாம் பாவம் சந்திரன் (களத்திர சுகம்)", desc: "குடும்ப மகிழ்ச்சி, வணிக லாபம் மற்றும் இனிமையான பயணம்.", isFavorable: true }
  },
  8: {
    kn: { title: "ಅಷ್ಟಮ ಚಂದ್ರ (೮ನೇ ಭಾವ - ಚಂದ್ರಾಷ್ಟಮ ರಕ್ಷಾ ಕಾಲ)", desc: "ಚಂದ್ರಾಷ್ಟಮ ಸಂಚಾರ: ಮಾನಸಿಕ ಸೂಕ್ಷ್ಮತೆ ಹೆಚ್ಚಿರುತ್ತದೆ. ನೂತನ ಒಪ್ಪಂದ ಅಥವಾ ಸಾಹಸಗಳು ಬೇಡ; ಶ್ರೀ ಮಹಾಬಲೇಶ್ವರ ಧ್ಯಾನ ಕ್ಷೇಮ.", isFavorable: false },
    en: { title: "8th House Chandra (Chandrashtama Vigilance)", desc: "Chandrashtama transit: Heightened emotional sensitivity. Defer high-stakes risks and chant Shiva mantras.", isFavorable: false },
    hi: { title: "अष्टम चंद्र (8वां भाव - चंद्राष्टम सतर्कता)", desc: "चंद्राष्टम प्रभाव: नए जोखिम न लें। शिव आराधना करें, ध्यान करें और शांत रहें।", isFavorable: false },
  ...
  9: {
    kn: { title: "ನವಮ ಚಂದ್ರ (೯ನೇ ಭಾವ - ಭಾಗ್ಯೋದಯ & ಧರ್ಮ)", desc: "ಧಾರ್ಮಿಕ ಪುಣ್ಯ ಕಾರ್ಯಗಳು, ಗುರು-ಹಿರಿಯರ ದರ್ಶನ, ಭಾಗ್ಯ ವೃದ್ಧಿ ಹಾಗೂ ಕೈಗೊಂಡ ಸತ್ಕಾರ್ಯಗಳಲ್ಲಿ ದೈವಬಲ ಪ್ರಾಪ್ತಿ.", isFavorable: true },
    en: { title: "9th House Chandra (Fortune & Righteousness)", desc: "Spiritual elevation, blessings from mentors, righteous good deeds, and unexpected divine fortune.", isFavorable: true },
    hi: { title: "नवम चंद्र (9वां भाव - भाग्योदय)", desc: "धार्मिक रुचि, गुरुजनों का आशीर्वाद एवं सत्कर्मों से भाग्योदय।", isFavorable: true },
    te: { title: "నవమ చంద్రుడు (9వ భావం - భాగ్య స్థానం)", desc: "ధార్మిక చింతన, పెద్దల ఆశీస్సులు మరియు శుభ కార్య సంకల్పం.", isFavorable: true },
    ta: { title: "ஒன்பதாம் பாவம் சந்திரன் (பாக்ய ஸ்தானம்)", desc: "ஆன்மீக நாட்டம், பெரியோரின் ஆசி மற்றும் நற்செயல்கள்.", isFavorable: true }
  },
  10: {
    kn: { title: "ದಶಮ ಚಂದ್ರ (೧೦ನೇ ಭಾವ - ಕರ್ಮ ಜಯ & ಕೀರ್ತಿ)", desc: "ಉದ್ಯೋಗದಲ್ಲಿ ಪದೋನ್ನತಿ, ಹಿರಿಯ ಅಧಿಕಾರಿಗಳಿಂದ ಮೆಚ್ಚುಗೆ, ಅಧಿಕಾರ ಬಲ ಹಾಗೂ ಸಕಲ ವ್ಯವಹಾರಗಳಲ್ಲಿ ಕೀರ್ತಿ.", isFavorable: true },
    en: { title: "10th House Chandra (Career Elevation)", desc: "Supreme career recognition, professional authority, praise from leaders, and major business breakthroughs.", isFavorable: true },
    hi: { title: "दशम चंद्र (10वां भाव - कर्म सिद्धि)", desc: "कार्यक्षेत्र में उन्नति, पद-प्रतिष्ठा, वरिष्ठों की प्रशंसा एवं उत्तम सफलता।", isFavorable: true },
    te: { title: "దశమ చంద్రుడు (10వ భావం - ఉద్యోగ సిద్ధి)", desc: "ఉద్యోగంలో ఉన్నతి, కీర్తి ప్రతిష్టలు మరియు సమస్త కార్య సిద్ధి.", isFavorable: true },
    ta: { title: "பத்தாம் பாவம் சந்திரன் (தொழில் வெற்றி)", desc: "தொழில் மேன்மை, புகழ் மற்றும் அனைத்து காரியங்களிலும் வெற்றி.", isFavorable: true }
  },
  11: {
    kn: { title: "ಏಕಾದಶ ಚಂದ್ರ (೧೧ನೇ ಭಾವ - ಸರ್ವತೋಮುಖ ಲಾಭ)", desc: "ಅಪಾರ ಧನ ಲಾಭ, ನೂತನ ಆದಾಯ ಮೂಲಗಳು, ದೀರ್ಘಕಾಲದ ಆಸೆಗಳ ಈಡೇರಿಕೆ ಹಾಗೂ ಕೌಟುಂಬಿಕ ಸಂತೋಷೋತ್ಸವ.", isFavorable: true },
    en: { title: "11th House Chandra (Supreme Gains & Fulfillment)", desc: "Exponential financial prosperity, unexpected liquidity, wish fulfillment, and joyful celebrations.", isFavorable: true },
  ...
  12: {
    kn: { title: "ದ್ವಾದಶ ಚಂದ್ರ (೧೨ನೇ ಭಾವ - ಶುಭ ವ್ಯಯ & ಆಧ್ಯಾತ್ಮ)", desc: "ಶುಭ ಕಾರ್ಯಗಳಿಗೆ ಧನ ವ್ಯಯ, ದೂರದ ಊರುಗಳಿಂದ ಸಂಪರ್ಕ, ಏಕಾಂತ ಧ್ಯಾನಕ್ಕೆ ಪ್ರಶಸ್ತ. ಸಾತ್ವಿಕ ದಾನ ಶ್ರೇಷ್ಠ.", isFavorable: false },
    en: { title: "12th House Chandra (Spiritual Inwardness & Spend)", desc: "Expenditures on noble/auspicious causes, distant connections, and inner meditation. Conserve sleep.", isFavorable: false },
    hi: { title: "द्वादश चंद्र (12वां भाव - व्यय व वैराग्य)", desc: "शुभ कार्यों पर व्यय, लंबी यात्रा के योग। दान-पुण्य करना विशेष लाभकारी।", isFavorable: false },
    te: { title: "ద్వాదశ చంద్రుడు (12వ భావం - వ్యయ స్థానం)", desc: "శుభ కార్యాలకు ధన వ్యయం, దూర ప్రయాణాలు. దానధర్మాలు శ్రేష్టం.", isFavorable: false },
    ta: { title: "பன்னிரண்டாம் பாவம் சந்திரன் (விரய ஸ்தானம்)", desc: "நற்காரியங்களுக்கு செலவு, தூரப் பயணம். தான தர்மங்கள் சிறப்பு.", isFavorable: false }
  }
};

export const TARA_BALA_DESCRIPTIONS: Record<number, Record<SevaLang, { name: string; desc: string; isGood: boolean }>> = {
  1: {
    kn: { name: "ಜನ್ಮ ತಾರೆ", desc: "ಸಾಮಾನ್ಯ ಫಲ. ಆರೋಗ್ಯ ಮತ್ತು ನಿದ್ರೆಯ ಬಗ್ಗೆ ಕಾಳಜಿ ಇರಲಿ.", isGood: false },
    en: { name: "Janma Tara", desc: "Moderate energy. Maintain physical balance and sleep hygiene.", isGood: false },
  ...
  2: {
    kn: { name: "ಸಂಪತ್ ತಾರೆ (ಅತ್ಯಂತ ಶುಭ)", desc: "ಧನ ಸಂಪತ್ತು, ಆರ್ಥಿಕ ಐಶ್ವರ್ಯ ವೃದ್ಧಿ ಹಾಗೂ ಸಕಲ ಲಾಭ.", isGood: true },
    en: { name: "Sampat Tara (Supreme Wealth)", desc: "Wealth accumulation, material prosperity, and financial breakthroughs.", isGood: true },
  ...
  3: {
    kn: { name: "ವಿಪತ್ ತಾರೆ (ಎಚ್ಚರಿಕೆ)", desc: "ಕಾರ್ಯಗಳಲ್ಲಿ ಸಣ್ಣ ವಿಳಂಬ ಸಾಧ್ಯತೆ. ಎಚ್ಚರಿಕೆಯ ಹೆಜ್ಜೆ ಇಡಿ.", isGood: false },
    en: { name: "Vipat Tara (Caution)", desc: "Possible friction. Double-check all important communications.", isGood: false },
    hi: { name: "विपत तारा (सतर्कता)", desc: "कार्यों में विघ्न संभव। सतर्कता से कार्य करें।", isGood: false },
    te: { name: "విపత్ తార (జాగ్రత్త)", desc: "పనులలో ఆటంకాలు రావచ్చు. జాగ్రత్తగా వ్యవహరించండి.", isGood: false },
    ta: { name: "விபத் தாரை (கவனம்)", desc: "தடைகள் வரலாம். கவனமாக செயல்படவும்.", isGood: false }
  },
  4: {
    kn: { name: "ಕ್ಷೇಮ ತಾರೆ (ಸರ್ವ ರಕ್ಷೆ)", desc: "ಕುಟುಂಬ ರಕ್ಷಣೆ, ನೆಮ್ಮದಿ ಹಾಗೂ ಸಕಲ ಕ್ಷೇಮ.", isGood: true },
    en: { name: "Kshema Tara (Divine Well-Being)", desc: "Domestic peace, family security, and auspicious blessings.", isGood: true },
  ...
  5: {
    kn: { name: "ಪ್ರತ್ಯಕ್ ತಾರೆ (ಮಧ್ಯಮ)", desc: "ಅಡೆತಡೆಗಳು ಎದುರಾಗಬಹುದು. ಹಿರಿಯರ ಸಲಹೆ ಪಡೆದು ನಿರ್ಧರಿಸಿ.", isGood: false },
    en: { name: "Pratyak Tara (Patience)", desc: "Obstacles may test resolve. Consult experienced mentors.", isGood: false },
  ...
  6: {
    kn: { name: "ಸಾಧನ ತಾರೆ (ಕಾರ್ಯ ಸಿದ್ಧಿ)", desc: "ಶ್ರಮಕ್ಕೆ ತಕ್ಕ ವಿಜಯ, ಗುರಿ ಸಾಧನೆ ಹಾಗೂ ಸಾರ್ವಜನಿಕ ಗೌರವ.", isGood: true },
    en: { name: "Sadhana Tara (Accomplishment)", desc: "Success in targeted endeavors, goal achievement, and honor.", isGood: true },
  ...
  7: {
    kn: { name: "ನೈಧನ ತಾರೆ (ಶಾಂತಿ ಜಪ)", desc: "ಸಾಹಸ ಕೃತ್ಯಗಳಿಂದ ದೂರವಿರಿ. ಮಹಾಮೃತ್ಯುಂಜಯ ಸ್ಮರಣೆ ಮಾಡಿ.", isGood: false },
    en: { name: "Naidhana Tara (Protection)", desc: "Avoid high-risk ventures. Chant Mahamrityunjaya mantra.", isGood: false },
  ...
  8: {
    kn: { name: "ಮಿತ್ರ ತಾರೆ (ಶುಭ)", desc: "ಸ್ನೇಹಿತರ ಸಹಕಾರ, ಪ್ರೀತಿ, ಆನಂದ ಮತ್ತು ಸೌಹಾರ್ದ.", isGood: true },
    en: { name: "Mitra Tara (Friendly Grace)", desc: "Warm collaborations, peer assistance, and joyful connections.", isGood: true },
  ...
  9: {
    kn: { name: "ಪರಮ ಮಿತ್ರ ತಾರೆ (ಮಹಾ ಶುಭ)", desc: "ಪೂರ್ಣ ಕಾರ್ಯ ಸಿದ್ಧಿ, ದೈವಾನುಗ್ರಹ ಹಾಗೂ ಸರ್ವತೋಮುಖ ಲಾಭ.", isGood: true },
    en: { name: "Parama Mitra Tara (Supreme Blessing)", desc: "Total triumph in key tasks, divine guidance, and peak achievements.", isGood: true },
...
export async function getOrComputeDinaBhavishya(params: DinaBhavishyaParams): Promise<DinaBhavishyaPayload> {
  ...
  const chandraBalaInfo = CHANDRA_BALA_RULES[chandraBalaHouse]?.[lang] || CHANDRA_BALA_RULES[chandraBalaHouse]?.en || {
    title: `Chandra Bala (${chandraBalaHouse}th House)`,
    desc: "Cosmic planetary alignment.",
    isFavorable: true
  };

  // Tara Bala: (Transit Nakshatra - Natal Nakshatra + 27) % 27
  ...
  // Active Vimshottari Dasha-Bhukti Calculation
  let activeMaha: PlanetName = PlanetName.Jupiter;
  let activeBhukti: PlanetName = PlanetName.Sun;
  let activeDashaSummary = "";
  ...
  if (birthDate) {
    try {
      ...
      const ageYears = Math.max(0, (targetDateObj.getTime() - birthDateObj.getTime()) / (365.2425 * 24 * 3600 * 1000));
      const bhuktiData = findBhuktiAtAge(birthKundli, ageYears);
      if (bhuktiData) {
        activeMaha = bhuktiData.maha.planet;
        activeBhukti = bhuktiData.bhukti;
      }
    } catch {
      // fallback defaults
    }
  ...
  if (lang === "kn") {
    ...
    careerAndFinance = chandraBalaInfo.isFavorable
      ? `कार्यक्षेत्र में मान-सम्मान, अधिकारियों का सहयोग एवं आर्थिक लाभ के योग हैं। नए निवेश एवं व्यापार विस्तार के लिए दिन अनुकूल है।`
      : `आर्थिक मामलों में जल्दबाजी से बचें। अनावश्यक खर्चों पर नियंत्रण रखें और अनुभवी लोगों से सलाह लेकर ही कदम उठाएं।`;
    healthAndFamily = chandraBalaHouse === 8
      ? `चंद्राष्टम प्रभाव: मानसिक शांति बनाए रखने के लिए ध्यान और शिव मंत्र का जाप करें। परिवार में वाद-विवाद से बचें।`
      : `शारीरिक ऊर्जा उत्तम रहेगी। परिवार में सौहार्दपूर्ण वातावरण रहेगा तथा परिजनों का स्नेह प्राप्त होगा।`;
    travelAndInitiatives = taraBalaInfo.isGood
    ...
    careerAndFinance = chandraBalaInfo.isFavorable
      ? `వృత్తి ఉద్యోగాలలో గౌరవం మరియు ధన లాభం లభిస్తాయి. నూతన పెట్టుబడులకు మరియు పనుల ప్రారంభానికి అనుకూల సమయం.`
      : `ఆర్థిక వ్యవహారాలలో జాగ్రత్త వహించండి. తొందరపాటు నిర్ణయాలు మానుకోండి.`;
    healthAndFamily = chandraBalaHouse === 8
      ? `చంద్రాష్టమ సంచారం: ప్రశాంతంగా ఉండండి, ధ్యానం మరియు శివార్చన చేయండి. కుటుంబంలో సంయమనం పాటించండి.`
      : `శారీరక ఆరోగ్యం బాగుంటుంది. కుటుంబంలో శాంతి మరియు ఆనందం వెల్లివిరుస్తాయి.`;
    travelAndInitiatives = taraBalaInfo.isGood
    ...
    careerAndFinance = chandraBalaInfo.isFavorable
      ? `தொழில் மற்றும் பணியில் மரியாதை, பண வரவு மற்றும் முன்னேற்றம் ஏற்படும். புதிய திட்டங்களுக்கு நற்பலன் உண்டு.`
      : `நிதி விவகாரங்களில் கவனமாக இருக்கவும். தேவையற்ற செலவுகளைத் தவிர்க்கவும்.`;
    healthAndFamily = chandraBalaHouse === 8
      ? `சந்திராஷ்டம காலம்: மன அமைதிக்காக தியானம் மற்றும் சிவ மந்திரம் ஜபிக்கவும்.`
      : `உடல் நலம் சீராக இருக்கும். குடும்பத்தில் அமைதியும் மகிழ்ச்சியும் நிலவும்.`;
    travelAndInitiatives = taraBalaInfo.isGood
    ...
    careerAndFinance = chandraBalaInfo.isFavorable
      ? `Professional recognition, favorable team collaboration, and sound financial liquidity expected. Excellent window for negotiations.`
      : `Exercise prudent financial discretion. Avoid impulsive speculation and consult mentors before committing funds.`;
    healthAndFamily = chandraBalaHouse === 8
      ? `Chandrashtama requires mental calmness. Maintain satvik nourishment, inner meditation, and chant Om Namah Shivaya.`
      : `Physical vitality remains robust with harmonious domestic rapport and positive family interactions.`;
    travelAndInitiatives = taraBalaInfo.isGood
  ...
  if (geminiApiKey && geminiApiKey.trim().length > 0) {
    try {
      const langNames: Record<SevaLang, string> = {
        kn: "Kannada",
        en: "English",
        hi: "Hindi",
        te: "Telugu",
...
- Active Vimshottari Dasha: ${activeDashaSummary}
- Today's Gochara Moon: ${rashiName(transitMoonRashi, lang)} (${chandraBalaInfo.title} - ${chandraBalaInfo.desc})
- Today's Tara Bala: ${taraBalaInfo.name} (${taraBalaInfo.desc})
- Day Lord & Deity: ${deity.deityL5[lang]}
- Day Energy Score: ${energyScore}/100 (${energyScore >= 75 ? "Auspicious & Powerful" : energyScore >= 50 ? "Steady & Balanced" : "Caution & Calming Sadhana Required"})
...
Section 1: Daily Overview & Cosmic Energy (Chandra Bala + Tara Bala + Dasha influence)
---
Section 2: Career, Business & Finance (10th/11th/2nd house + Dasha synergy)
---
Section 3: Health, Mindset & Family Harmony (Mental peace, Chandrashtama remedies if house 8)
---
Section 4: Travel, Auspicious Timing & Day Guidance (Abhijit Muhurtha & Lucky attributes)
`;
      ...
      console.warn("[DinaBhavishya] GenAI synthesis fallback to deterministic Vedic rules:", err);
    }
  }
