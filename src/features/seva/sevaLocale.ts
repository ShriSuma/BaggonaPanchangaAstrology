...
export const T: Record<string, L5> = {
  ...
  qrPrintStep1: {
    ...
    kn: "೧. ನಿಮ್ಮ ಮೊಬೈಲ್ ಕ್ಯಾಮೆರಾ ತೆರೆಯಿರಿ",
    te: "౧. మీ మొబైల్ కెమెరాను తెరవండి",
    ta: "௧. உங்கள் மொபைல் கேமராவைத் திறக்கவும்",
    hi: "१. अपने मोबाइल का कैमरा खोलें"
  },
  qrPrintStep2: {
    en: "2. Point camera at the QR code above",
    kn: "೨. ಈ ಕ್ಯೂಆರ್ ಕೋಡ್ ಸ್ಕ್ಯಾನ್ ಮಾಡಿ",
    te: "౨. పైనున్న క్యూఆర్ కోడ్‌ను స్కాన్ చేయండి",
    ta: "௨. மேலே உள்ள QR குறியீட்டை ஸ்கேன் செய்யவும்",
    hi: "२. ऊपर दिए गए क्यूआर कोड को स्कैन करें"
  },
  qrPrintStep3: {
    en: "3. Tap the link to open Google Calendar",
    kn: "೩. ಕ್ಯಾಲೆಂಡರ್ ಸೇರಿಸಲು ಲಿಂಕ್ ಒತ್ತಿರಿ",
    te: "౩. క్యాలెండర్ జోడించడానికి లింక్ నొక్కండి",
    ta: "௩. காலெண்டரைச் சேர்க்க லிங்கைத் தட்டவும்",
    hi: "३. कैलेंडर जोड़ने के लिए लिंक पर क्लिक करें"
  },
  qrPrintStep4: {
    en: "4. Click 'Add' or 'Save' to save 90-day reminders",
    kn: "೪. ೯೦ ದಿನಗಳ ಪಂಚಾಂಗ ಸುಲಭವಾಗಿ ಸೇರ್ಪಡೆಯಾಗುತ್ತದೆ",
    te: "౪. 90 రోజుల పంచాంగ జ్ఞాపికలు సులభంగా జతచేయబడతాయి",
    ta: "௪. 90 நாட்களுக்கான பஞ்சாங்கம் உடனடியாக சேமிக்கப்படும்",
    hi: "४. ९० दिनों का पंचांग आपके कैलेंडर में जुड़ जाएगा"
  },
...
export interface NakshatraMantraInfo {
  name: L5;
  deity: L5;
  mantra: L5;
  japaCount: L5;
...
export const NAKSHATRA_MANTRAS_L5: Record<number, NakshatraMantraInfo> = {
  0: {
    name: { kn: "ಅಶ್ವಿನಿ", hi: "अश्विनी", te: "అశ్విని", ta: "அஸ்வினி", en: "Ashwini" },
    deity: { kn: "ಅಶ್ವಿನೀ ಕುಮಾರರು (ದೈವಿಕ ವೈದ್ಯರು)", hi: "अश्विनी कुमार", te: "అశ్వినీ దేవతలు", ta: "அஸ்வினி தேவர்கள்", en: "Ashwini Kumaras" },
    mantra: {
      kn: "॥ ॐ ಅಶ್ವಿನೀಕುಮಾರಾಭ್ಯಾಂ ನಮಃ ॥",
      hi: "॥ ॐ अश्विनीकुमाराभ्यां नमः ॥",
      te: "॥ ఓం అశ్వినీకుమారాభ్యాం నమః ॥",
      ta: "॥ ஓம் அஸ்வினி குமாரப்யாம் நமஹ ॥",
      en: "॥ Om Ashwini Kumarabhyam Namah ॥"
    },
    japaCount: { kn: "ಪ್ರತಿದಿನ ೧೦೮ ಬಾರಿ", hi: "प्रतिदिन १०८ बार", te: "రోజూ 108 సార్లు", ta: "தினமும் 108 முறை", en: "108 Times Daily" },
    benefit: {
      kn: "ಆರೋಗ್ಯ ವೃದ್ಧಿ, ಶೀಘ್ರ ಕಾರ್ಯಸಿದ್ಧಿ ಹಾಗೂ ದೈವಿಕ ತೇಜಸ್ಸನ್ನು ನೀಡುತ್ತದೆ.",
      hi: "आरोग्य वृद्धि, शीघ्र कार्यसिद्धि एवं दिव्य तेज प्रदान करता है।",
      te: "ఆరోగ్య వృద్ధి, శీఘ్ర కార్యసిద్ధి మరియు దివ్య తేజస్సును ఇస్తుంది.",
      ta: "ஆரோக்கியம், விரைவான காரியசித்தி மற்றும் தைரியம் தரும்.",
      en: "Bestows vibrant vitality, swift accomplishment, and divine radiance."
    }
  },
  1: {
    name: { kn: "ಭರಣಿ", hi: "भरणी", te: "భరణి", ta: "பரணி", en: "Bharani" },
    deity: { kn: "ಯಮ ಧರ್ಮರಾಜ", hi: "यम धर्मराज", te: "యమ ధర్మరాజు", ta: "எம தர்மராஜா", en: "Yama Dharmaraja" },
    mantra: {
      kn: "॥ ॐ ಯಮಾಯ ನಮಃ ॥",
      hi: "॥ ॐ यमाय नमः ॥",
      te: "॥ ఓం యమాయ నమః ॥",
    ...
    japaCount: { kn: "ಪ್ರತಿದಿನ ೧೦೮ ಬಾರಿ", hi: "प्रतिदिन १०८ बार", te: "రోజూ 108 సార్లు", ta: "தினமும் 108 முறை", en: "108 Times Daily" },
    benefit: {
      kn: "ಆಪತ್ತು ನಿವಾರಣೆ, ಶಿಸ್ತು, ಧರ್ಮನಿಷ್ಠೆ ಹಾಗೂ ದೀರ್ಘಾಯುಷ್ಯವನ್ನು ಕರುಣಿಸುತ್ತದೆ.",
      hi: "विपत्ति निवारण, अनुशासन, धर्मनिष्ठा एवं दीर्घायु प्रदान करता है।",
      te: "ఆపదలు తొలగి, క్రమశిక్షణ, ధర్మనిష్ఠ మరియు దీర్ఘాయుష్షు లభిస్తాయి.",
      ta: "துன்பங்கள் நீங்கி, ஒழுக்கம் மற்றும் நீண்ட ஆயுள் தரும்.",
      en: "Dissolves dangers, granting righteous discipline and long lifespan."
    }
  },
  2: {
    name: { kn: "ಕೃತ್ತಿಕಾ", hi: "कृत्तिका", te: "కృత్తికా", ta: "கிருத்திகை", en: "Krittika" },
    deity: { kn: "ಅಗ್ನಿ ದೇವ", hi: "अग्नि देव", te: "అగ్ని దేవుడు", ta: "அக்னி தேவன்", en: "Agni Deva" },
    mantra: {
      kn: "॥ ॐ ಅಗ್ನಯೇ ನಮಃ ॥",
      hi: "॥ ॐ अग्नये नमः ॥",
      te: "॥ ఓం అగ్నయే నమః ॥",
    ...
    japaCount: { kn: "ಪ್ರತಿದಿನ ೧೦೮ ಬಾರಿ", hi: "प्रतिदिन १०८ बार", te: "రోజూ 108 సార్లు", ta: "தினமும் 108 முறை", en: "108 Times Daily" },
    benefit: {
      kn: "ಪಾಪ ನಾಶ, ದೇಹದಲ್ಲಿ ಚೈತನ್ಯ ಹಾಗೂ ನಾಯಕತ್ವ ತೇಜಸ್ಸನ್ನು ಹೆಚ್ಚಿಸುತ್ತದೆ.",
      hi: "पाप नाश, शारीरिक ऊर्जा एवं नेतृत्व तेज में वृद्धि करता है।",
      te: "పాపాలు నశించి, నాయకత్వ తేజస్సు మరియు ఉత్సాహం పెరుగుతాయి.",
      ta: "பாவங்கள் நீங்கி, தலைமைத்துவ ஆற்றல் மற்றும் வீரியம் தரும்.",
      en: "Purifies karmas, awakening leadership brilliance and vital energy."
    }
  },
  3: {
    name: { kn: "ರೋಹಿಣಿ", hi: "रोहिणी", te: "రోహిణి", ta: "ரோகிணி", en: "Rohini" },
    deity: { kn: "ಬ್ರಹ್ಮ ದೇವ (ಪ್ರಜಾಪತಿ)", hi: "ब्रह्मा प्रजापति", te: "బ్రహ్మ ప్రజాపతి", ta: "பிரம்ம தேவன் (பிரஜாபதி)", en: "Brahma Prajapati" },
    mantra: {
      kn: "॥ ॐ ಪ್ರಜಾಪತಯೇ ನಮಃ ॥",
      hi: "॥ ॐ प्रजापतये नमः ॥",
      te: "॥ ఓం ప్రజాపతయే నమః ॥",
      ta: "॥ ஓம் பிரஜாபதயே நமஹ ॥",
      en: "॥ Om Prajapataye Namah ॥"
    },
    japaCount: { kn: "ಪ್ರತಿದಿನ ೧೦೮ ಬಾರಿ", hi: "प्रतिदिन १०८ बार", te: "రోజూ 108 సార్లు", ta: "தினமும் 108 முறை", en: "108 Times Daily" },
    benefit: {
      kn: "ಸೃಜನಶೀಲತೆ, ಸೌಂದರ್ಯ, ಕೌಟುಂಬಿಕ ಸಮೃದ್ಧಿ ಹಾಗೂ ಕೀರ್ತಿಯನ್ನು ತರುತ್ತದೆ.",
      hi: "सृजनशीलता, सौंदर्य, पारिवारिक समृद्धि एवं कीर्ति प्रदान करता है।",
      te: "సృజనాత్మకత, సౌందర్యం, కుటుంబ సమృద్ధి మరియు కీర్తిని ఇస్తుంది.",
      ta: "படைப்பாற்றல், அழகு, குடும்ப சுபிட்சம் மற்றும் புகழ் தரும்.",
      en: "Bestows artistic creativity, elegance, family abundance, and renown."
    }
  },
  4: {
    name: { kn: "ಮೃಗಶಿರ", hi: "मृगशिरा", te: "మృగశిర", ta: "மிருகசீரிடம்", en: "Mrigashira" },
    deity: { kn: "ಸೋಮ ದೇವ (ಚಂದ್ರ)", hi: "सोम देव (चंद्र)", te: "సోమ దేవుడు (చంద్రుడు)", ta: "சந்திர தேவன் (சோமன்)", en: "Soma (Moon God)" },
    mantra: {
      kn: "॥ ॐ ಸೋಮಾಯ ನಮಃ ॥",
      hi: "॥ ॐ सोमाय नमः ॥",
      te: "॥ ఓం సోమాయ నమః ॥",
    ...
    japaCount: { kn: "ಪ್ರತಿದಿನ ೧೦೮ ಬಾರಿ", hi: "प्रतिदिन १०८ बार", te: "రోజూ 108 సార్లు", ta: "தினமும் 108 முறை", en: "108 Times Daily" },
    benefit: {
      kn: "ಮನಃಶಾಂತಿ, ಜ್ಞಾನಾನ್ವೇಷಣೆ, ಮಧುರ ವಾಕ್ ಹಾಗೂ ಸೌಭಾಗ್ಯ ನೀಡುತ್ತದೆ.",
      hi: "मानसिक शांति, ज्ञान प्राप्ति, मधुर वाणी एवं सौभाग्य प्रदान करता है।",
      te: "మనశ్శాంతి, జ్ఞానాన్వేషణ, మధుర వాక్కు మరియు సౌభాగ్యం లభిస్తాయి.",
      ta: "மன அமைதி, ஞானம், இனிய வாக்கு மற்றும் சௌபாக்கியம் தரும்.",
      en: "Bestows serene tranquility, intellectual curiosity, and sweet speech."
    }
  },
  5: {
    name: { kn: "ಆರ್ದ್ರಾ", hi: "आर्द्रा", te: "ఆరుద్ర", ta: "திருவாதிரை", en: "Ardra" },
    deity: { kn: "ರುದ್ರ ದೇವ (ಶಿವ)", hi: "रुद्र देव (शिव)", te: "రుద్రుడు (శివుడు)", ta: "ருத்ர தேவன் (சிவபெருமான்)", en: "Rudra (Lord Shiva)" },
    mantra: {
      kn: "॥ ॐ ರುದ್ರಾಯ ನಮಃ ॥",
      hi: "॥ ॐ रुद्राय नमः ॥",
      te: "॥ ఓం రుద్రాయ నమః ॥",
    ...
    japaCount: { kn: "ಪ್ರತಿದಿನ ೧೦೮ ಬಾರಿ", hi: "प्रतिदिन १०८ बार", te: "రోజೂ 108 సార్లు", ta: "தினமும் 108 முறை", en: "108 Times Daily" },
    benefit: {
      kn: "ಕಷ್ಟಗಳ ನಿವಾರಣೆ, ಅಡೆತಡೆಗಳ ನಾಶ ಹಾಗೂ ಸಂಕಷ್ಟಗಳಿಂದ ದೈವಿಕ ರಕ್ಷಣೆ ನೀಡುತ್ತದೆ.",
      hi: "कष्ट निवारण, बाधाओं का नाश एवं संकटों से दिव्य रक्षा करता है।",
      te: "కష్టాలు తొలగి, ఆటంకాలు నశించి దివ్య రక్షణ లభిస్తుంది.",
      ta: "துன்பங்கள் நீங்கி, தடைகள் அகன்று சங்கடங்களிலிருந்து காக்கும்.",
      en: "Annihilates adversities and shields from severe life crises."
    }
  },
  6: {
    name: { kn: "ಪುನರ್ವಸು", hi: "पुनर्वसु", te: "పునర్వసు", ta: "புனர்பூசம்", en: "Punarvasu" },
    deity: { kn: "ಅದಿತಿ ದೇವಿ (ದೇವಮಾತೆ)", hi: "अदिति देवी (देवमाता)", te: "అదితి దేవి (దేవమాత)", ta: "அதிதி தேவி (தேவமாதா)", en: "Aditi (Mother of Gods)" },
    mantra: {
      kn: "॥ ॐ ಅದಿತ್ಯೈ ನಮಃ ॥",
      hi: "॥ ॐ अदित्यै नमः ॥",
      te: "॥ ఓం ఆదిత్యై నమః ॥",
    ...
    japaCount: { kn: "ಪ್ರತಿದಿನ ೧೦೮ ಬಾರಿ", hi: "प्रतिदिन १०८ बार", te: "రోజೂ 108 సార్లు", ta: "தினமும் 108 முறை", en: "108 Times Daily" },
    benefit: {
      kn: "ಪುನರುತ್ಥಾನ, ಕಳೆದುಕೊಂಡ ಐಶ್ವರ್ಯ ಮರಳಿ ಪಡೆಯುವುದು ಹಾಗೂ ಮಾತೃ ಕೃಪೆ ನೀಡುತ್ತದೆ.",
      hi: "पुनरुत्थान, खोई हुई समृद्धि की पुनः प्राप्ति एवं मातृ कृपा देता है।",
      te: "పునరుత్థానం, కోల్పోయిన ఐశ్వర్యం తిరిగి పొందడం మరియు మాతృ కృప లభిస్తాయి.",
      ta: "மறுமலர்ச்சி, இழந்த சொத்துக்களை மீட்டெடுத்தல் மற்றும் அன்னை அருள் தரும்.",
      en: "Fosters restoration of lost fortune, renewal, and divine motherly grace."
    }
  },
  7: {
    name: { kn: "ಪುಷ್ಯ", hi: "पुष्य", te: "పుష్యమి", ta: "பூசம்", en: "Pushya" },
    deity: { kn: "ಬೃಹಸ್ಪತಿ (ದೇವಗುರು)", hi: "बृहस्पति (देवगुरु)", te: "బృహస్పతి (దేవగురువు)", ta: "பிருஹஸ்பதி (தேவகுரு)", en: "Brihaspati (Guru)" },
    mantra: {
      kn: "॥ ॐ ಬೃಹಸ್ಪತಯೇ ನಮಃ ॥",
      hi: "॥ ॐ बृहस्पतये नमः ॥",
      te: "॥ ఓం బృహస్పతయే నమః ॥",
      ta: "॥ ஓம் பிருஹஸ்பதயே நமஹ ॥",
      en: "॥ Om Brihaspataye Namah ॥"
    },
    japaCount: { kn: "ಪ್ರತಿದಿನ ೧೦೮ ಬಾರಿ", hi: "प्रतिदिन १०८ बार", te: "రోజೂ 108 సార్లు", ta: "தினமும் 108 முறை", en: "108 Times Daily" },
    benefit: {
      kn: "ಜ್ಞಾನ, ಆಧ್ಯಾತ್ಮಿಕ ಉನ್ನತಿ, ಸದ್ಬುದ್ಧಿ ಹಾಗೂ ಸರ್ವತೋಮುಖ ಪೋಷಣೆ ನೀಡುತ್ತದೆ.",
      hi: "ज्ञान, आध्यात्मिक उन्नति, सद्बुद्धि एवं सर्वांगीण पोषण प्रदान करता है।",
      te: "జ్ఞానం, ఆధ్యాత్మిక ఉన్నతి, సద్బుద్ధి మరియు సమస్త పోషణ లభిస్తాయి.",
      ta: "ஞானம், ஆன்மீக உயர்வு, நற்புத்தி மற்றும் பரிபூரண வளம் தரும்.",
      en: "Cultivates profound wisdom, spiritual ascent, and all-round nourishment."
    }
  },
  8: {
    name: { kn: "ಆಶ್ಲೇಷಾ", hi: "आश्लेषा", te: "ఆశ్లేష", ta: "ஆயில்யம்", en: "Ashlesha" },
    deity: { kn: "ನಾಗ ದೇವತೆಗಳು (ಸರ್ಪ)", hi: "नाग देवता (सर्प)", te: "నాగ దేవతలు (సర్పాలు)", ta: "நாக தேவதைகள் (சர்ப்பங்கள்)", en: "Nagas (Serpent Deities)" },
    mantra: {
      kn: "॥ ॐ ಸರ್ಪೇಭ್ಯೋ ನಮಃ ॥",
      hi: "॥ ॐ सर्पेभ्यो नमः ॥",
      te: "॥ ఓం సర్పేభ్యో నమః ॥",
      ta: "॥ ஓம் சர்ப்பேப்யோ நமஹ ॥",
      en: "॥ Om Sarpebhyo Namah ॥"
    },
    japaCount: { kn: "ಪ್ರತಿದಿನ ೧೦೮ ಬಾರಿ", hi: "प्रतिदिन १०८ बार", te: "రోజೂ 108 సార్లు", ta: "தினமும் 108 முறை", en: "108 Times Daily" },
    benefit: {
      kn: "ಕುಂಡಲಿನೀ ಜಾಗೃತಿ, ಶತ್ರು ಭಯ ನಿವಾರಣೆ ಹಾಗೂ ನಿಗೂಢ ಜ್ಞಾನ ಸಿದ್ಧಿಸುತ್ತದೆ.",
      hi: "कुंडलिनी जागरण, शत्रु भय निवारण एवं गूढ़ ज्ञान की सिद्धि होती है।",
      te: "కుండలినీ జాగృతి, శత్రు భయం తొలగి నిగూఢ జ్ఞానం లభిస్తుంది.",
      ta: "குண்டலினி விழிப்புணர்வு, எதிரி பயம் நீங்குதல் மற்றும் உள்ளுணர்வு பலம் தரும்.",
      en: "Awakens intuitive insight, protection from enemies, and occult wisdom."
    }
  },
  9: {
    name: { kn: "ಮಘಾ", hi: "मघा", te: "మఘ", ta: "மகம்", en: "Magha" },
    deity: { kn: "ಪಿತೃ ದೇವತೆಗಳು", hi: "पितृ देवता", te: "పితృ దేవతలు", ta: "பித்ரு தேவர்கள்", en: "Pitrus (Ancestors)" },
    mantra: {
      kn: "॥ ॐ ಪಿತೃಭ್ಯೋ ನಮಃ ॥",
      hi: "॥ ॐ पितृभ्यो नमः ॥",
      te: "॥ ఓం పితృభ్యో నమః ॥",
      ta: "॥ ஓம் பித்ருப்யோ நமஹ ॥",
      en: "॥ Om Pitrubhyo Namah ॥"
    },
    japaCount: { kn: "ಪ್ರತಿದಿನ ೧೦೮ ಬಾರಿ", hi: "प्रतिदिन १०८ बार", te: "రోజೂ 108 సార్లు", ta: "தினமும் 108 முறை", en: "108 Times Daily" },
    benefit: {
      kn: "ಪಿತೃ ಕೃಪೆ, ರಾಜಗೌರವ, ವಂಶಾಭಿವೃದ್ಧಿ ಹಾಗೂ ಅಧಿಕಾರ ಪ್ರಾಪ್ತಿಯಾಗುತ್ತದೆ.",
      hi: "पितृ कृपा, राज सम्मान, वंशाभिवृद्धि एवं अधिकार की प्राप्ति होती है।",
      te: "పితృ కృప, రాజగౌరవం, వంశాభివృద్ధి మరియు అధికారం లభిస్తాయి.",
      ta: "பித்ரு ஆசீர்வாதம், அரச மரியாதை, வம்ச விருத்தி மற்றும் பதவி யோகம் தரும்.",
      en: "Bestows ancestral blessings, royal prestige, and authoritative status."
    }
  },
  10: {
    name: { kn: "ಪೂರ್ವ ಫಲ್ಗುಣಿ", hi: "पूर्वा फाल्गुनी", te: "పూర్వ ఫల్గుణి", ta: "பூரம்", en: "Purva Phalguni" },
    deity: { kn: "ಭಗ ದೇವ (ಸೂರ್ಯ ಸಂಭೂತ)", hi: "भग देव", te: "భగ దేవుడు", ta: "பக தேவன்", en: "Bhaga Deva" },
    mantra: {
      kn: "॥ ॐ ಭಗಾಯ ನಮಃ ॥",
      hi: "॥ ॐ भगाय नमः ॥",
      te: "॥ ఓం భగాయ నమః ॥",
    ...
    japaCount: { kn: "ಪ್ರತಿದಿನ ೧೦೮ ಬಾರಿ", hi: "प्रतिदिन १०८ बार", te: "రోజೂ 108 సార్లు", ta: "தினமும் 108 முறை", en: "108 Times Daily" },
    benefit: {
      kn: "ವೈವಾಹಿಕ ಸುಖ, ಪ್ರೇಮ, ಭೋಗ ಭಾಗ್ಯ ಹಾಗೂ ಅದೃಷ್ಟವನ್ನು ಕರುಣಿಸುತ್ತದೆ.",
      hi: "वैवाहिक सुख, प्रेम, भौतिक समृद्धि एवं भाग्य प्रदान करता है।",
      te: "వైవాహిక సుఖం, ప్రేమ, భోగభాగ్యాలు మరియు అదృష్టం లభిస్తాయి.",
      ta: "தாம்பத்ய சுகம், அன்பு, செல்வ செழிப்பு மற்றும் நல்லதிர்ஷ்டம் தரும்.",
      en: "Enriches marital harmony, romantic bliss, and material prosperity."
    }
  },
  11: {
    name: { kn: "ಉತ್ತರ ಫಲ್ಗುಣಿ", hi: "उत्तरा फाल्गुनी", te: "ఉత్తర ఫల్గుణి", ta: "உத்திரம்", en: "Uttara Phalguni" },
    deity: { kn: "ಅರ್ಯಮನ್ ದೇವ", hi: "अर्यमा देव", te: "అర్యముడు", ta: "அர்யமா தேவன்", en: "Aryaman Deva" },
    mantra: {
      kn: "॥ ॐ ಅರ್ಯಮ್ಣೇ ನಮಃ ॥",
      hi: "॥ ॐ अर्यम्णे नमः ॥",
      te: "॥ ఓం అర్యమ్ణే నమః ॥",
    ...
    japaCount: { kn: "ಪ್ರತಿದಿನ ೧೦೮ ಬಾರಿ", hi: "प्रतिदिन १०८ बार", te: "రోజೂ 108 సార్లు", ta: "தினமும் 108 முறை", en: "108 Times Daily" },
    benefit: {
      kn: "ಸ್ಥಿರ ಮೈತ್ರಿ, ಕರುಣೆ, ಸಮಾಜದಲ್ಲಿ ಸಾರ್ವಜನಿಕ ಗೌರವ ಹಾಗೂ ಕಲ್ಯಾಣ ನೀಡುತ್ತದೆ.",
      hi: "स्थिर मित्रता, करुणा, समाज में सम्मान एवं कल्याण प्रदान करता है।",
      te: "స్థిరమైన స్నేహం, దయ, సమాజంలో గౌరవం మరియు శుభాలు కలుగుతాయి.",
      ta: "நிலையான நட்பு, இரக்கம், சமூக மதிப்பு மற்றும் நன்மைகள் தரும்.",
      en: "Solidifies loyal alliances, compassion, social prestige, and welfare."
    }
  },
  12: {
    ...
    japaCount: { kn: "ಪ್ರತಿದಿನ ೧೦೮ ಬಾರಿ", hi: "प्रतिदिन १०८ बार", te: "రోజೂ 108 సార్లు", ta: "தினமும் 108 முறை", en: "108 Times Daily" },
    benefit: {
      kn: "ಹಸ್ತ ಕೌಶಲ್ಯ, ವ್ಯಾಪಾರ ಬುದ್ಧಿ, ವಾಕ್ ಸಿದ್ಧಿ ಹಾಗೂ ಆರೋಗ್ಯ ತೇಜಸ್ಸು ನೀಡುತ್ತದೆ.",
      hi: "हस्त कौशल, व्यापार बुद्धि, वाक् सिद्धि एवं आरोग्य तेज देता है।",
      te: "చేతి నైపుణ్యం, వ్యాపార బుద్ధి, వాక్ సిద్ధి మరియు ఆరోగ్య తేజస్సు లభిస్తాయి.",
      ta: "கைவினைத் திறன், வியாபார புத்தி, வாக்கு சித்தி மற்றும் ஆரோக்கியம் தரும்.",
      en: "Sharpens professional craftsmanship, mercantile brilliance, and eloquence."
    }
  },
  13: {
    name: { kn: "ಚಿತ್ರಾ", hi: "चित्रा", te: "చిత్త", ta: "சித்திரை", en: "Chitra" },
    deity: { kn: "ತ್ವಷ್ಟಾ (ವಿಶ್ವಕರ್ಮ)", hi: "त्वष्टा (विश्वकर्मा)", te: "త్వష్ట (విశ్వకర్మ)", ta: "துவஷ்டா (விஸ்வகர்மா)", en: "Tvashtar (Divine Architect)" },
    mantra: {
      kn: "॥ ॐ ತ್ವಷ್ಟ್ರೇ ನಮಃ ॥",
      hi: "॥ ॐ त्वष्ट्रे नमः ॥",
      te: "॥ ఓం త్వష్ట్రే నమః ॥",
      ta: "॥ ஓம் துவஷ்ட்ரே நமஹ ॥",
      en: "॥ Om Tvashtre Namah ॥"
    },
    japaCount: { kn: "ಪ್ರತಿದಿನ ೧೦೮ ಬಾರಿ", hi: "प्रतिदिन १०८ बार", te: "రోజೂ 108 సార్లు", ta: "தினமும் 108 முறை", en: "108 Times Daily" },
    benefit: {
      kn: "ಚಿತ್ರಕಲೆ, ವಾಸ್ತು, ವಾಸ್ತುಶಿಲ್ಪ, ಸೌಂದರ್ಯ ನಿರ್ಮಾಣ ಹಾಗೂ ಆಕರ್ಷಕ ವ್ಯಕ್ತಿತ್ವ ನೀಡುತ್ತದೆ.",
      hi: "कला, वास्तुकला, सौंदर्य निर्माण एवं आकर्षक व्यक्तित्व प्रदान करता है।",
      te: "కళలు, వాస్తు, శిల్పకళ, సౌందర్య నిర్మాణం మరియు ఆకర్షణీయమైన వ్యక్తిత్వం లభిస్తాయి.",
      ta: "கலை, வாஸ்து, கட்டிடக்கலை, அழகு உணர்வு மற்றும் கவர்ச்சிகரமான ஆளுமை தரும்.",
      en: "Inspires architectural mastery, visual design, and magnetic charm."
    }
  },
  14: {
    name: { kn: "ಸ್ವಾತಿ", hi: "स्वाति", te: "స్వాతి", ta: "சுவாதி", en: "Swati" },
    deity: { kn: "ವಾಯು ದೇವ (ಪವನ)", hi: "वायु देव (पवन)", te: "వాయు దేవుడు", ta: "வாயு தேவன்", en: "Vayu Deva" },
    mantra: {
      kn: "॥ ॐ ವಾಯವೇ ನಮಃ ॥",
      hi: "॥ ॐ वायवे नमः ॥",
      te: "॥ ఓం వాయవే నమః ॥",
    ...
    japaCount: { kn: "ಪ್ರತಿದಿನ ೧೦೮ ಬಾರಿ", hi: "प्रतिदिन १०८ बार", te: "రోజೂ 108 సార్లు", ta: "தினமும் 108 முறை", en: "108 Times Daily" },
    benefit: {
      kn: "ಸ್ವಾತಂತ್ರ್ಯ, ಚುರುಕುತನ, ಪ್ರಾಣಾಯಾಮ ಬಲ ಹಾಗೂ ವ್ಯಾಪಾರ ವಿಸ್ತರಣೆ ನೀಡುತ್ತದೆ.",
      hi: "स्वतंत्रता, चपलता, प्राणशक्ति एवं व्यापार विस्तार प्रदान करता है।",
      te: "స్వతంత్రత, చురుకుదనం, ప్రాణశక్తి మరియు వ్యాపార విస్తరణ లభిస్తాయి.",
      ta: "சுதந்திர சிந்தனை, சுறுசுறுப்பு, பிராண சக்தி மற்றும் தொழில் விரிவாக்கம் தரும்.",
      en: "Nourishes independence, adaptability, vitality, and commercial reach."
    }
  },
  15: {
    name: { kn: "ವಿಶಾಖಾ", hi: "विशाखा", te: "విశాఖ", ta: "விசாகம்", en: "Vishakha" },
    deity: { kn: "ಇಂದ್ರಾಗ್ನಿ (ಇಂದ್ರ & ಅಗ್ನಿ)", hi: "इंद्राग्नि (इंद्र एवं अग्नि)", te: "ఇంద్రాగ్నులు", ta: "இந்திராக்னி", en: "Indragni (Indra & Agni)" },
    mantra: {
      kn: "॥ ॐ ಇಂದ್ರಾಗ್ನಿಭ್ಯಾಂ ನಮಃ ॥",
      hi: "॥ ॐ इंद्राग्निभ्यां नमः ॥",
      te: "॥ ఓం ఇంద్రాగ్నిభ్యాం నమః ॥",
      ta: "॥ ஓம் இந்திராக்னிப்யாம் நமஹ ॥",
      en: "॥ Om Indragnibhyam Namah ॥"
    },
    japaCount: { kn: "ಪ್ರತಿದಿನ ೧೦೮ ಬಾರಿ", hi: "प्रतिदिन १०८ बार", te: "రోజೂ 108 సార్లు", ta: "தினமும் 108 முறை", en: "108 Times Daily" },
    benefit: {
      kn: "ದೃಢ ಸಂಕಲ್ಪ, ಜಯ, ಧ್ಯೇಯ ಸಿದ್ಧಿ ಹಾಗೂ ಧೈರ್ಯ-ಸ್ಥೈರ್ಯಗಳನ್ನು ನೀಡುತ್ತದೆ.",
      hi: "दृढ़ संकल्प, विजय, लक्ष्य सिद्धि एवं साहस प्रदान करता है।",
      te: "దృఢ సంకల్పం, విజయం, లక్ష్య సాధన మరియు ధైర్యం లభిస్తాయి.",
      ta: "திடசங்கற்பம், வெற்றி, இலக்கு அடைதல் மற்றும் துணிச்சல் தரும்.",
      en: "Infuses resolute focus, triumphant achievement, and courageous tenacity."
    }
  },
  16: {
    name: { kn: "ಅನುರಾಧಾ", hi: "अनुराधा", te: "అనూరాధ", ta: "அனுஷம்", en: "Anuradha" },
    deity: { kn: "ಮಿತ್ರ ದೇವ (ಸೂರ್ಯ)", hi: "मित्र देव", te: "మిత్ర దేవుడు", ta: "மித்ர தேவன்", en: "Mitra Deva" },
    mantra: {
      kn: "॥ ॐ ಮಿತ್ರಾಯ ನಮಃ ॥",
      hi: "॥ ॐ मित्राय नमः ॥",
      te: "॥ ఓం మిత్రాయ నమః ॥",
    ...
    japaCount: { kn: "ಪ್ರತಿದಿನ ೧೦೮ ಬಾರಿ", hi: "प्रतिदिन १०८ बार", te: "రోజೂ 108 సార్లు", ta: "தினமும் 108 முறை", en: "108 Times Daily" },
    benefit: {
      kn: "ಭಕ್ತಿ, ಸ್ನೇಹ, ಅಂತಾರಾಷ್ಟ್ರೀಯ ಯಶಸ್ಸು ಹಾಗೂ ಕೌಟುಂಬಿಕ ಪ್ರೀತಿ ತರುತ್ತದೆ.",
      hi: "भक्ति, मित्रता, अंतर्राष्ट्रीय सफलता एवं पारिवारिक प्रेम बढ़ाता है।",
      te: "భక్తి, స్నేహం, అంతర్జాతీయ విజయం మరియు కుటుంబ ప్రేమ పెరుగుతాయి.",
      ta: "பக்தி, நட்பு, சர்வதேச வெற்றி மற்றும் குடும்ப பாசம் தரும்.",
      en: "Deepens devotion, diplomatic friendship, and global travel success."
    }
  },
  17: {
    name: { kn: "ಜ್ಯೇಷ್ಠಾ", hi: "ज्येष्ठा", te: "జ్యేష్ఠ", ta: "கேட்டை", en: "Jyeshtha" },
    deity: { kn: "ಇಂದ್ರ ದೇವ (ದೇವಕುಲಾಧಿಪತಿ)", hi: "इंद्र देव (देवराज)", te: "ఇంద్రుడు (దేవరాజు)", ta: "இந்திரன் (தேவராஜன்)", en: "Indra (King of Gods)" },
    mantra: {
      kn: "॥ ॐ ಇಂದ್ರಾಯ ನಮಃ ॥",
      hi: "॥ ॐ इंद्राय नमः ॥",
      te: "॥ ఓం ఇంద్రాయ నమః ॥",
    ...
    japaCount: { kn: "ಪ್ರತಿದಿನ ೧೦೮ ಬಾರಿ", hi: "प्रतिदिन १०८ बार", te: "రోజೂ 108 సార్లు", ta: "தினமும் 108 முறை", en: "108 Times Daily" },
    benefit: {
      kn: "ಹಿರಿತನ, ರಕ್ಷಣೆ, ನಾಯಕತ್ವ, ಗೌರವ ಹಾಗೂ ಜ್ಯೇಷ್ಠತಾ ಬಲವನ್ನು ನೀಡುತ್ತದೆ.",
      hi: "ज्येष्ठता, सुरक्षा, नेतृत्व, सम्मान एवं विजय प्रदान करता है।",
      te: "పెద్దరికం, రక్షణ, నాయకత్వం, గౌరవం మరియు అధిపత్య బలం లభిస్తాయి.",
      ta: "தலைமைத்துவம், பாதுகாப்பு, ஆளுமை, மரியாதை மற்றும் வெற்றி தரும்.",
      en: "Commands seniority, royal protection, executive authority, and status."
    }
  },
  18: {
    name: { kn: "ಮೂಲ", hi: "मूल", te: "మూల", ta: "மூலம்", en: "Mula" },
    deity: { kn: "ನಿರೃತಿ ದೇವಿ (ಮೂಲ ಶಕ್ತಿ)", hi: "निरृति देवी", te: "నిరృతి దేవి", ta: "நிருருதி தேவி", en: "Nirriti (Root Goddess)" },
    mantra: {
      kn: "॥ ॐ ನಿರೃತಯೇ ನಮಃ ॥",
      hi: "॥ ॐ निरृतये नमः ॥",
      te: "॥ ఓం నిరృతయే నమః ॥",
    ...
    japaCount: { kn: "ಪ್ರತಿದಿನ ೧೦೮ ಬಾರಿ", hi: "प्रतिदिन १०८ बार", te: "రోజೂ 108 సార్లు", ta: "தினமும் 108 முறை", en: "108 Times Daily" },
    benefit: {
      kn: "ಮೂಲ ದೋಷ ನಿವಾರಣೆ, ಆಳವಾದ ಸಂಶೋಧನಾ ಶಕ್ತಿ ಹಾಗೂ ಆಧ್ಯಾತ್ಮಿಕ ಮುಕ್ತಿ ನೀಡುತ್ತದೆ.",
      hi: "मूल दोष निवारण, गहन शोध क्षमता एवं आध्यात्मिक मुक्ति प्रदान करता है।",
      te: "మూల దోష నివారణ, లోతైన పరిశోధనా శక్తి మరియు ఆధ్యాత్మిక ముక్తి లభిస్తాయి.",
      ta: "மூல தோஷ நிவர்த்தி, ஆழ்ந்த ஆராய்ச்சி திறன் மற்றும் ஆன்மீக முக்தி தரும்.",
      en: "Dissolves root karmic doshas, conferring penetrative insight and liberation."
    }
  },
  19: {
    name: { kn: "ಪೂರ್ವಾಷಾಢ", hi: "पूर्वाषाढ़ा", te: "పూర్వాషాఢ", ta: "பூராடம்", en: "Purva Ashadha" },
    deity: { kn: "ಅಪಸ್ (ಜಲ ದೇವತೆ)", hi: "आपस (जल देवी)", te: "అపస్ (జల దేవి)", ta: "அபஸ் (ஜல தேவி)", en: "Apas (Water Goddess)" },
    mantra: {
      kn: "॥ ॐ ಅದ್ಭ್ಯೋ ನಮಃ ॥",
      hi: "॥ ॐ अद्भ्यो नमः ॥",
      te: "॥ ఓం అద్భ్యో నమః ॥",
    ...
    japaCount: { kn: "ಪ್ರತಿದಿನ ೧೦೮ ಬಾರಿ", hi: "प्रतिदिन १०८ बार", te: "రోజೂ 108 సార్లు", ta: "தினமும் 108 முறை", en: "108 Times Daily" },
    benefit: {
      kn: "ಅಪರಾಜಿತ ವಿಜಯ, ಜನಪ್ರಿಯತೆ, ಶುದ್ಧತೆ ಹಾಗೂ ಸಕಲ ಕಾರ್ಯಗಳಲ್ಲಿ ಜಯ ನೀಡುತ್ತದೆ.",
      hi: "अपराजित विजय, लोकप्रियता, पवित्रता एवं सर्व कार्यों में सफलता देता है।",
      te: "అపరాజిత విజయం, ప్రజాదరణ, పవిత్రత మరియు సర్వకార్యాలలో విజయం లభిస్తాయి.",
      ta: "தோல்வியற்ற வெற்றி, நற்புகழ், புனிதம் மற்றும் அனைத்து காரியங்களிலும் வெற்றி தரும்.",
      en: "Grants invincible triumph, charisma, inner purification, and widespread fame."
    }
  },
  20: {
    name: { kn: "ಉತ್ತರಾಷಾಢ", hi: "उत्तराषाढ़ा", te: "ఉత్తరాషాఢ", ta: "உத்திராடம்", en: "Uttara Ashadha" },
    deity: { kn: "ವಿಶ್ವೇದೇವತೆಗಳು (ಸರ್ವದೇವ)", hi: "विश्वेदेवा", te: "విశ్వేదేవతలు", ta: "விஸ்வேதேவர்கள்", en: "Vishwadevas" },
    mantra: {
    ...
    japaCount: { kn: "ಪ್ರತಿದಿನ ೧೦೮ ಬಾರಿ", hi: "प्रतिदिन १०८ बार", te: "రోజೂ 108 సార్లు", ta: "தினமும் 108 முறை", en: "108 Times Daily" },
    benefit: {
      kn: "ಸಾರ್ವತ್ರಿಕ ವಿಜಯ, ಶಾಶ್ವತ ಕೀರ್ತಿ, ಸತ್ಯನಿಷ್ಠೆ ಹಾಗೂ ದೈವಾನುಗ್ರಹ ನೀಡುತ್ತದೆ.",
      hi: "सार्वभौम विजय, स्थायी कीर्ति, सत्यनिष्ठा एवं दैवानुग्रह प्रदान करता है।",
      te: "సార్వత్రిక విజయం, శాశ్వత కీర్తి, సత్యనిష్ఠ మరియు దైవానుగ్రహం లభిస్తాయి.",
      ta: "பூரண வெற்றி, நிலையான புகழ், வாய்மை மற்றும் இறை அருள் தரும்.",
      en: "Attracts universal victory, enduring reputation, and ethical sovereignty."
    }
  },
  21: {
    name: { kn: "ಶ್ರವಣ", hi: "श्रवण", te: "శ్రవణ", ta: "திருவோணம்", en: "Shravana" },
    deity: { kn: "ವಿಷ್ಣು ದೇವ (ಶ್ರೀ ಹರಿ)", hi: "भगवान विष्णु", te: "విష్ణు దేవుడు (శ్రీహరి)", ta: "மகா விஷ்ணு", en: "Lord Vishnu" },
    mantra: {
      kn: "॥ ॐ ವಿಷ್ಣವೇ ನಮಃ ॥",
      hi: "॥ ॐ विष्णवे नमः ॥",
      te: "॥ ఓం విష్ణవే నమః ॥",
    ...
    japaCount: { kn: "ಪ್ರತಿದಿನ ೧೦೮ ಬಾರಿ", hi: "प्रतिदिन १०८ बार", te: "రోజೂ 108 సార్లు", ta: "தினமும் 108 முறை", en: "108 Times Daily" },
    benefit: {
      kn: "ಶ್ರವಣ ಜ್ಞಾನ, ಸಂಪೂರ್ಣ ರಕ್ಷಣೆ, ಧನ-ಧಾನ್ಯ ಸಮೃದ್ಧಿ ಹಾಗೂ ವಿದ್ಯಾ ಸಿದ್ಧಿ ನೀಡುತ್ತದೆ.",
      hi: "श्रवण ज्ञान, पूर्ण सुरक्षा, धन-धान्य समृद्धि एवं विद्या सिद्धि देता है।",
      te: "శ్రవణ జ్ఞానం, సంపూర్ణ రక్షణ, ధనధాన్య సమృద్ధి మరియు విద్యా సిద్ధి లభిస్తాయి.",
      ta: "கேள்வி ஞானம், பரிபூரண பாதுகாப்பு, செல்வ வளம் மற்றும் கல்வி மேன்மை தரும்.",
      en: "Bestows acute learning retention, divine preservation, and academic mastery."
    }
  },
  22: {
    name: { kn: "ಧನಿಷ್ಠಾ", hi: "धनिष्ठा", te: "ధనిష్ఠ", ta: "அவிட்டம்", en: "Dhanishtha" },
    deity: { kn: "ಅಷ್ಟ ವಸುಗಳು", hi: "अष्ट वसु", te: "అష్ట వసువులు", ta: "அஷ்ட வசுக்கள்", en: "Ashta Vasus" },
    mantra: {
      kn: "॥ ॐ ವಸುಭ್ಯೋ ನಮಃ ॥",
      hi: "॥ ॐ वसुभ्यो नमः ॥",
      te: "॥ ఓం వసుభ్యో నమః ॥",
    ...
    japaCount: { kn: "ಪ್ರತಿದಿನ ೧೦೮ ಬಾರಿ", hi: "प्रतिदिन १०८ बार", te: "రోజೂ 108 సార్లు", ta: "தினமும் 108 முறை", en: "108 Times Daily" },
    benefit: {
      kn: "ಅಖಂಡ ಧನಲಾಭ, ಸಂಗೀತ-ನಾಟ್ಯ ಕಲೆ, ಆಸ್ತಿ ವೃದ್ಧಿ ಹಾಗೂ ಕೀರ್ತಿಯನ್ನು ತರುತ್ತದೆ.",
      hi: "अखंड धनलाभ, संगीत-कला, संपत्ति वृद्धि एवं कीर्ति प्रदान करता है।",
      te: "అఖండ ధనలాభం, సంగీతం, స్థిరాస్తి వృద్ధి మరియు కీర్తి లభిస్తాయి.",
      ta: "அளப்பரிய செல்வம், இசை-கலை மேன்மை, சொத்து சேர்க்கை மற்றும் புகழ் தரும்.",
      en: "Magnifies wealth flow, musical talent, real estate expansion, and prestige."
    }
  },
  23: {
    name: { kn: "ಶತಭಿಷಾ", hi: "शतभिषा", te: "శతభిషం", ta: "சதயம்", en: "Shatabhisha" },
    deity: { kn: "ವರುಣ ದೇವ (ಜಲಾಧಿಪತಿ)", hi: "वरुण देव", te: "వరుణ దేవుడు", ta: "வருண தேவன்", en: "Varuna Deva" },
    mantra: {
      kn: "॥ ॐ ವರುಣಾಯ ನಮಃ ॥",
      hi: "॥ ॐ वरुणाय नमः ॥",
      te: "॥ ఓం వరుణಾಯ నమః ॥",
    ...
    japaCount: { kn: "ಪ್ರತಿದಿನ ೧೦೮ ಬಾರಿ", hi: "प्रतिदिन १०८ बार", te: "రోజೂ 108 సార్లు", ta: "தினமும் 108 முறை", en: "108 Times Daily" },
    benefit: {
      kn: "ಶತ ರೋಗ ನಿವಾರಣೆ, ಆಯುರ್ವೇದ ಚಿಕಿತ್ಸಾ ಸಿದ್ಧಿ ಹಾಗೂ ದೀರ್ಘಾಯುಷ್ಯ ನೀಡುತ್ತದೆ.",
      hi: "सौ रोगों का निवारण, आरोग्य सिद्धि एवं दीर्घायु प्रदान करता है।",
      te: "శత రోగ నివారణ, వైద్య చికిత్సా సిద్ధి మరియు దీర్ఘాయుష్షు లభిస్తాయి.",
      ta: "சகல நோய்கள் தீருதல், மருத்துவ சித்தி மற்றும் நீண்ட ஆயுள் தரும்.",
      en: "Cures ailments, conferring healing power, longevity, and mystic vision."
    }
  },
  24: {
    name: { kn: "ಪೂರ್ವ ಭಾದ್ರಪದ", hi: "पूर्वाभाद्रपद", te: "పూర్వాభాద్ర", ta: "பூரட்டாதி", en: "Purva Bhadrapada" },
    deity: { kn: "ಅಜೈಕಪಾದ (ರುದ್ರ ರೂಪ)", hi: "अजैकपाद (रुद्र)", te: "అజైకపాదుడు", ta: "அஜைகபாதர்", en: "Aja Ekapada" },
    mantra: {
      kn: "॥ ॐ ಅಜೈಕಪಾದಾಯ ನಮಃ ॥",
      hi: "॥ ॐ अजैकपादाय नमः ॥",
      te: "॥ ఓం అజైకపాదాయ నమః ॥",
    ...
    japaCount: { kn: "ಪ್ರತಿದಿನ ೧೦೮ ಬಾರಿ", hi: "प्रतिदिन १०८ बार", te: "ರೋಜೂ 108 ಸార్లు", ta: "தினமும் 108 முறை", en: "108 Times Daily" },
    benefit: {
      kn: "ತಪಸ್ಸು, ವೈರಾಗ್ಯ, ಆಧ್ಯಾತ್ಮಿಕ ಸಾಧನೆ ಹಾಗೂ ದೈವಿಕ ರಕ್ಷಣೆ ನೀಡುತ್ತದೆ.",
      hi: "तपस्या, वैराग्य, आध्यात्मिक सिद्धि एवं दिव्य सुरक्षा प्रदान करता है।",
      te: "తపస్సు, వైరాగ్యం, ఆధ్యాత్మిక సాధన మరియు దివ్య రక్షణ లభిస్తాయి.",
      ta: "தவம், வைராக்கியம், ஆன்மீக பலம் மற்றும் இறை பாதுகாப்பு தரும்.",
      en: "Strengthens ascetic discipline, spiritual focus, and divine invulnerability."
    }
  },
  25: {
    name: { kn: "ಉತ್ತರ ಭಾದ್ರಪದ", hi: "उत्तराभाद्रपद", te: "ఉత్తరాభాద్ర", ta: "உத்திரட்டாதி", en: "Uttara Bhadrapada" },
    deity: { kn: "ಅಹಿರ್ಬುಧ್ನ್ಯ (ಅನಂತ ಶೇಷ)", hi: "अहिर्बुध्न्य (शेषनाग)", te: "అహిర్బుధ్న్యుడు (శేషనాగు)", ta: "அஹிர்புத்னியர் (சேஷநாகம்)", en: "Ahirbudhnya" },
    mantra: {
    ...
    japaCount: { kn: "ಪ್ರತಿದಿನ ೧೦೮ ಬಾರಿ", hi: "प्रतिदिन १०८ बार", te: "రోజೂ 108 సార్లు", ta: "தினமும் 108 முறை", en: "108 Times Daily" },
    benefit: {
      kn: "ಗಂಭೀರತೆ, ಮೋಕ್ಷ ಸಾಧನೆ, ಕುಂಡಲಿನೀ ಸ್ಥಿರತೆ ಹಾಗೂ ಆಂತರಿಕ ಶಾಂತಿ ನೀಡುತ್ತದೆ.",
      hi: "गंभीरता, मोक्ष साधना, कुंडलिनी स्थिरता एवं आंतरिक शांति देता है।",
      te: "గాంభీర్యం, మోక్ష సాధన, కుండలినీ స్థిరత్వం మరియు అంతశ్శాంతి లభిస్తాయి.",
      ta: "மன அமைதி, முக்தி சாதனை, குண்டலினி நிலைத்தன்மை மற்றும் உள்ளொளி தரும்.",
      en: "Anchors serene kundalini stability, deep contemplation, and moksha."
    }
  },
  26: {
    name: { kn: "ರೇವತಿ", hi: "रेवती", te: "రేవతి", ta: "ரேவதி", en: "Revati" },
    deity: { kn: "ಪೂಷನ್ ದೇವ (ಪೋಷಕ)", hi: "पूषा देव", te: "పూష దేవుడు", ta: "பூஷண் தேவன்", en: "Pushan Deva" },
    mantra: {
      kn: "॥ ॐ ಪೂಷ್ಣೇ ನಮಃ ॥",
      hi: "॥ ॐ पूष्णे नमः ॥",
      te: "॥ ఓం పూష్ణೇ ನಮಃ ॥",
    ...
    japaCount: { kn: "ಪ್ರತಿದಿನ ೧೦೮ ಬಾರಿ", hi: "प्रतिदिन १०८ बार", te: "ರೋಜೂ 108 ಸార్లు", ta: "தினமும் 108 முறை", en: "108 Times Daily" },
    benefit: {
      kn: "ಪ್ರಯಾಣ ರಕ್ಷಣೆ, ಪಶು ಸಂಪತ್ತು, ಸುಖ-ಶಾಂತಿ ಹಾಗೂ ಅಂತಿಮ ಮುಕ್ತಿ ನೀಡುತ್ತದೆ.",
      hi: "यात्रा सुरक्षा, पशु समृद्धि, सुख-शांति एवं अंतिम मुक्ति प्रदान करता है।",
      te: "ప్రయాణ రక్షణ, పశు సంపద, సుఖశాంతులు మరియు మోక్షం లభిస్తాయి.",
      ta: "பயண பாதுகாப்பு, செல்வ வளம், சுக-சாந்தி மற்றும் முக்தி தரும்.",
      en: "Protects journeys, fostering wealth of cattle/assets, harmony, and final release."
    }
  }
};

export const getNakshatraMantraInfo = (nakshatraIndex?: number): NakshatraMantraInfo => {
  const safeIdx = (nakshatraIndex !== undefined && nakshatraIndex >= 0 && nakshatraIndex < 27)
    ? Math.floor(nakshatraIndex)
    : 0;
