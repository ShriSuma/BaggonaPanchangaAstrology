...
export const T_KAALA_DIKSUCHI = {
  ...
  tabDiksuchiCompass: {
    kn: "🧭 ದಿಕ್ಸೂಚಿ & ಕಾಲ ಮುಹೂರ್ತ",
    en: "🧭 Direction & Timing Compass",
    hi: "🧭 दिक्सूची एवं काल मुहूर्त",
    te: "🧭 దిక్సూచి & కాల ముహూర్తం",
    ta: "🧭 திக்சூசி & கால முகூர்த்தம்"
  },
  tabModernWorld: {
    kn: "🌐 ವರ್ತಮಾನ ಜೀವನ ಮಾರ್ಗದರ್ಶಿ",
    en: "🌐 Modern Life Navigator",
    hi: "🌐 वर्तमान जीवन मार्गदर्शक",
    te: "🌐 వర్తమాన జీవన మార్గదర్శనం",
    ta: "🌐 நவீன வாழ்க்கை வழிகாட்டி"
  },
  tabLiveTransit: {
