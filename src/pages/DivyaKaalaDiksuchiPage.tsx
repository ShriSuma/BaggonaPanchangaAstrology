...
import { DiksuchiCompassLoader } from "../components/loaders/DiksuchiCompassLoader";
  ...
  return (
    <div className="min-h-screen py-4 sm:py-6 px-3 sm:px-6 max-w-5xl mx-auto text-slate-900 dark:text-slate-100">
      ...
      {(isProcessing || isGeneratingPdf) && (
        <DiksuchiCompassLoader
          isKn={isKn}
          title={isGeneratingPdf ? "📜 ದಿವ್ಯ ಕಾಲ ದಿಕ್ಸೂಚಿ PDF ಸಿದ್ಧವಾಗುತ್ತಿದೆ..." : undefined}
          message={isGeneratingPdf ? "೮ ದಿಕ್ಕುಗಳ ಫಲ, ಕಾಲ ಚಕ್ರ ಹಾಗೂ ವಾಸ್ತು-ಮುಹೂರ್ತ ವರದಿ ಡೌನ್‌ಲೋಡ್ ಆಗುತ್ತಿದೆ..." : undefined}
        />
      )}
    </div>
  );
