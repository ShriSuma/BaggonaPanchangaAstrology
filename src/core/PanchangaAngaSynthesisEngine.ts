...
export const generateInstantQAList = (
  ...
  const lagnaRashi = kundli.lagnaRashi.sanskrit;
  const lagnaEng = kundli.lagnaRashi.english;
  const moon = kundli.planets.find((p) => p.name === PlanetName.Moon);
  const moonRashi = kundli.moonSign.sanskrit;
  ...
  const dashaSummary = diagnosis.prasthuthaSthiti.runningDashaSummary;
  const gemName = prescriptions?.gemstoneRing?.primaryGemstoneKn || "ಮಾಣಿಕ್ಯ";
  const gemCarat = prescriptions?.gemstoneRing?.caratWeight || "4.25 - 5.50 ಕ್ಯಾರಟ್";
  ...
  return [
    // 1. CAREER & BUSINESS
    {
      ...
      panditScriptKn: `ನಮಸ್ಕಾರ ${name}, ನಾನ್ ನಿಮ್ಮ ಜಾತಕ ನೋಡಿದೆ. ನೋಡಿದ್ರೆ ಇದರಲ್ಲಿ 10ನೇ ಮನೆಯಲ್ಲಿ (ಕರ್ಮ ಸ್ಥಾನ) ${tenthLord} ಗ್ರಹದ ಸ್ಥಿತಿ ಹಾಗೂ ${dashaSummary.split("|")[0]} ಪ್ರಭಾವದಿಂದ ನಿಮಗೆ ಕಾರ್ಯಕ್ಷೇತ್ರದಲ್ಲಿ ಸ್ವಲ್ಪ ಇವಾಗ ತೊಂದರೆ ಹಂಗೆ ಕಾಣಿಸ್ತಾ ಇದೆ. ನೀವು ಕಚೇರಿಯಲ್ಲಿ ಹಗಲಿರುಳು ನಿಸ್ವಾರ್ಥವಾಗಿ ಶ್ರಮಪಟ್ಟರೂ, ಆ ಶ್ರಮಕ್ಕೆ ತಕ್ಕ ಮನ್ನಣೆ ಸಿಗದೆ ನಿಮ್ಮ ಜಾಗದಲ್ಲಿ ಬೇರೆಯವರಿಗೆ ಆದ್ಯತೆ ಸಿಕ್ಕಿರುವುದು ನಿಮ್ಮ ಸ್ವಾಭಿಮಾನಕ್ಕೆ ನೋವುಂಟುಮಾಡಿದೆ, ಹೌದಲ್ಲವೇ?

ಪ್ರಸ್ತುತ ನಿಮ್ಮ ದೈನಂದಿನ ಸ್ಥಿತಿಯನ್ನು ನೋಡಿದರೆ, ನೀವು ಕಚೇರಿಗೆ ಹೋದರೂ ಪೂರ್ಣ ಮನಸ್ಸಿಲ್ಲದೆ ಕರ್ತವ್ಯ ಮುಗಿಸುವಂತಾಗಿದೆ. "ನನ್ನ ಪ್ರಾಮಾಣಿಕ ಪರಿಶ್ರಮಕ್ಕೆ ಬೆಲೆಯೇ ಇಲ್ಲವೇ?" ಎಂಬ ಅಸಹಾಯಕತೆ ಹಾಗೂ ಕೆಲಸ ಬದಲಾಯಿಸಬೇಕೆಂಬ ತುಡಿತ ನಿಮ್ಮನ್ನು ಸದಾ ಕಾಡ್ತಾನೆ ಇದೆ. ಈ ತರಹದ ಕೆಲವೊಂದು ಪರಿಸ್ಥಿತಿಗಳಿಂದ ನೀವು ನಿದ್ರಾಹೀನತೆಯಾಗಿ ಏನೋ ಯೋಚನೆ ಮಾಡ್ತಾ ಕಾಲ ಕಳಿತಾ ಇದೀರಾ.

ಆದರೆ ನಿಮ್ಮ ಜಾತಕದ 10ನೇ ಮನೆಯ ಅಧಿಪತಿಯ ಗೋಚಾರ ಸಂಚಾರದ ಪ್ರಕಾರ, ಮುಂದಿನ 3 ರಿಂದ 5 ತಿಂಗಳುಗಳಲ್ಲಿ (Next 3 to 5 Months) ಹೊಸ ಅತ್ಯುತ್ತಮ ಅವಕಾಶ ಅಥವಾ ಗೌರವಯುತ ಸ್ಥಾನ ಬದಲಾವಣೆ ಖಚಿತವಾಗಿ ಒದಗಿಬರಲಿದೆ. ಅಲ್ಲಿಯವರೆಗೆ ಕಚೇರಿಯಲ್ಲಿ ಯಾವುದೇ ವಾದ-ವಿವಾದಗಳಿಗೆ ಹೋಗಬೇಡಿ. ಪ್ರತಿದಿನ ಪ್ರಾತಃಕಾಲ ಆದಿತ್ಯ ಹೃದಯ ಸ್ತೋತ್ರ ಪಠಿಸಿ ಮತ್ತು ${lagnaRashi} ಲಗ್ನ ಬಲವರ್ಧನೆಗಾಗಿ ${gemName} (${gemCarat}) ಧರಿಸಿ.`,
      astrologicalBasisKn: `10ನೇ ಮನೆ (ಕರ್ಮ ಸ್ಥಾನ) ${tenthLord} ಗ್ರಹದ ಸ್ಥಿತಿ ಮತ್ತು ಗುರು-ಶನಿ ಗೋಚಾರ ಫಲ.`,
      immediateRemedyKn: `ಪ್ರತಿದಿನ ಪ್ರಾತಃಕಾಲ ಆದಿತ್ಯ ಹೃದಯ ಸ್ತೋತ್ರ ಪಠಿಸಿ ಮತ್ತು ${gemName} ಧರಿಸಿ.`
    },
    {
      id: "q_career_2",
      category: "career",
      ...
      panditScriptKn: `ನಮಸ್ಕಾರ ${name}, ನಾನ್ ನಿಮ್ಮ ಜಾತಕ ನೋಡಿದೆ. ನೋಡಿದ್ರೆ ಇದರಲ್ಲಿ 2ನೇ ಮನೆಯ ಧನಕೋಶ ಹಾಗೂ 11ನೇ ಮನೆಯಲ್ಲಿ ${eleventhLord} ಗ್ರಹದ ಪ್ರಭಾವದಿಂದಾಗಿ ವ್ಯಾಪಾರದಲ್ಲಿ ಇತ್ತೀಚೆಗೆ ಕೈಗೊಂಡ ಒಂದು ನಿರ್ಧಾರ ಅಥವಾ ನಂಬಿದ ವ್ಯಕ್ತಿಯಿಂದ ಉಂಟಾದ ಆರ್ಥಿಕ ಹೊಡೆತವು ನಿಮ್ಮ ವ್ಯವಹಾರದ ಗತಿಯನ್ನೇ ನಿಧಾನಗೊಳಿಸಿದೆ. ಬರಬೇಕಾದ ಬಾಕಿ ಹಣ ಸಮಯಕ್ಕೆ ಕೈಸೇರದೆ, ದಿನನಿತ್ಯದ ಬಂಡವಾಳ ಮತ್ತು ನಿರ್ವಹಣೆಗೆ ಪರದಾಡುವಂತಾಗಿದೆ.

ಈ ಘಟನೆಯಿಂದಾಗಿ ಈಗ ನಿಮ್ಮ ಮನಸ್ಸಲ್ಲಿ ನೆಮ್ಮದಿ ಇಲ್ಲ, ವ್ಯಾಪಾರವನ್ನು ಮುಂದುವರಿಸಬೇಕೋ ಅಥವಾ ನಿಲ್ಲಿಸಬೇಕೋ ಎಂಬ ದ್ವಂದ್ವ ಕಾಡ್ತಾನೆ ಇದೆ. ನೀವು ಎಷ್ಟು ಸಕಾರಾತ್ಮಕವಾಗಿರಲು ಪ್ರಯತ್ನಿಸಿದರೂ, ಹಣದ ಮುಗ್ಗಟ್ಟು ನಿಮ್ಮ ಹೊಸ ಯೋಜನೆಗಳನ್ನು ಕಾರ್ಯರೂಪಕ್ಕೆ ತರಲು ಬಿಡುತ್ತಿಲ್ಲ; ಪದೇ ಪದೇ ತೊಂದ್ರೆ ಕೊಡ್ತಾ ಇದೆ.

ಆದರೆ ನಿಮ್ಮ ಜಾತಕದ ಧನ ಸ್ಥಾನದ ಮೇಲಿನ ಗುರು ಗೋಚಾರ ದೃಷ್ಟಿಯ ಪ್ರಕಾರ, ಮುಂದಿನ 4 ರಿಂದ 6 ತಿಂಗಳುಗಳಲ್ಲಿ (Next 4 to 6 Months) ಮಾರುಕಟ್ಟೆಯಲ್ಲಿ ನಿಮ್ಮ ವ್ಯಾಪಾರಕ್ಕೆ ಹೊಸ ಗ್ರಾಹಕರು ಮತ್ತು ಹಣಕಾಸಿನ ಪುನಶ್ಚೇತನ ದೊರೆಯಲಿದೆ. ಬಾಕಿ ನಿಂತಿದ್ದ ಹಣ ವಸೂಲಿಯಾಗಲಿದೆ. ವ್ಯಾಪಾರ ಸ್ಥಳದಲ್ಲಿ ಶ್ರೀ ಯಂತ್ರ ಸ್ಥಾಪಿಸಿ ಶುಕ್ರವಾರ ಲಕ್ಷ್ಮೀ ಪೂಜೆ ನೆರವೇರಿಸಿ.`,
    ...
    },
    {
      ...
      panditScriptKn: `ನಮಸ್ಕಾರ ${name}, ನಾನ್ ನಿಮ್ಮ ಜಾತಕ ನೋಡಿದೆ. ನೋಡಿದ್ರೆ ನಿಮ್ಮ ${lagnaRashi} ಲಗ್ನದ ನೇರ ಮತ್ತು ಪ್ರಾಮಾಣಿಕ ನಡವಳಿಕೆಯೇ ಕಚೇರಿಯಲ್ಲಿ ಕೆಲವರಿಗೆ ಅಸೂಯೆ ಉಂಟುಮಾಡಿದೆ. 6ನೇ ಮನೆಯ (ಶತ್ರು ಸ್ಥಾನ) ${sixthLord} ಪ್ರಭಾವದಿಂದ ನೀವು ಮಾಡಿದ ಕೆಲಸದ ಕ್ರೆಡಿಟ್ ಅನ್ನು ಬೇರೆಯವರು ಪಡೆದುಕೊಳ್ಳುವುದು ಹಾಗೂ ನಿಮ್ಮ ವಿರುದ್ಧ ತೆರೆಮರೆಯಲ್ಲಿ ನಡೆಯುವ ರಾಜಕೀಯವು ನಿಮ್ಮ ಶಾಂತಿಯನ್ನು ಕೆಡಿಸಿದೆ.

ಪ್ರಸ್ತುತ ನೀವು ಕಚೇರಿಯಲ್ಲಿ ಎಲ್ಲರನ್ನೂ ನಂಬಿ ಮೋಸಹೋಗುವ ಭಯದಲ್ಲಿದ್ದೀರಿ. ನಿಮ್ಮ ಒಳ್ಳೆಯತನವನ್ನೇ ದೌರ್ಬಲ್ಯವೆಂದು ಭಾವಿಸಿ ಹೆಚ್ಚುವರಿ ಕೆಲಸದ ಹೊರೆಯನ್ನು ನಿಮ್ಮ ಮೇಲೆಯೇ ಹಾಕುತ್ತಿದ್ದಾರೆ; ಇದು ನಿಮ್ಮನ್ನು ಮಾನಸಿಕವಾಗಿ ಕುಗ್ಗಿಸುತ್ತಿದೆ.

ನಿಮ್ಮ ಜಾತಕದ ಕರ್ಮ ಮತ್ತು ಕೀರ್ತಿ ಸ್ಥಾನಗಳ ಗ್ರಹಬಲದ ಪ್ರಕಾರ, ಮುಂದಿನ 2 ರಿಂದ 4 ತಿಂಗಳುಗಳಲ್ಲಿ (Next 2 to 4 Months) ಸತ್ಯಾಂಶ ಹೊರಬರಲಿದ್ದು, ಹಿರಿಯ ಅಧಿಕಾರಿಗಳಿಗೆ ನಿಮ್ಮ ನೈಜ ಸಾಮರ್ಥ್ಯದ ಅರಿವಾಗಲಿದೆ. ಕಚೇರಿಯಲ್ಲಿ ವೈಯಕ್ತಿಕ ವಿಚಾರಗಳನ್ನು ಯಾರೊಂದಿಗೂ ಹಂಚಿಕೊಳ್ಳಬೇಡಿ. ನಿತ್ಯವೂ ಸುಬ್ರಹ್ಮಣ್ಯ ಅಷ್ಟಕ ಪಠಿಸಿ ಮತ್ತು ${rudraName} ಧಾರಣೆ ಮಾಡಿ.`,
      astrologicalBasisKn: `6ನೇ (ಶತ್ರು ಜಯ) ಮತ್ತು 10ನೇ ಮನೆಯ ಮೇಲಿನ ಛಾಯಾಗ್ರಹಗಳ ಗೋಚಾರ ಪ್ರಭಾವ.`,
      immediateRemedyKn: `ಪ್ರತಿ ಮಂಗಳವಾರ ಸುಬ್ರಹ್ಮಣ್ಯ ಅಷ್ಟಕ ಪಠಿಸಿ ಮತ್ತು ${rudraName} ಧಾರಣೆ ಮಾಡಿ.`
    },
    ...
    // 2. MARRIAGE & FAMILY
    {
      ...
      panditScriptKn: `ನಮಸ್ಕಾರ ${name}, ನಾನ್ ನಿಮ್ಮ ಜಾತಕ ನೋಡಿದೆ. ನೋಡಿದ್ರೆ ಇದರಲ್ಲಿ 7ನೇ ಮನೆಯಲ್ಲಿ (ಕಳತ್ರ ಸ್ಥಾನ) ${seventhLord} ಗ್ರಹದ ಸೂಕ್ಷ್ಮ ಸಂಚಾರದಿಂದಾಗಿ ವಿವಾಹದ ವಿಚಾರದಲ್ಲಿ ಈ ಹಿಂದೆ ಬಂದಿದ್ದ ಒಂದು ಒಳ್ಳೆಯ ಸಂಬಂಧ ಮಾತುಕತೆಯ ಅಂತಿಮ ಹಂತದಲ್ಲಿ ಮುರಿದುಬಿದ್ದ ಘಟನೆ ನಿಮ್ಮ ಹಾಗೂ ನಿಮ್ಮ ಕುಟುಂಬದವರ ಮನಸ್ಸಿಗೆ ತೀವ್ರ ನಿರಾಶೆ ತಂದಿದೆ.

ಈ ಘಟನೆಯ ನಂತರ ಈಗ ಬರುವ ಪ್ರತಿಯೊಂದು ಪ್ರಸ್ತಾಪದಲ್ಲೂ ಏನಾದರೊಂದು ಕೊರತೆ ಕಾಣುವುದು ಅಥವಾ ಮಾತುಕತೆಗಳು ಮುಂದುವರಿಯದೆ ನಿಧಾನವಾಗುತ್ತಿರುವುದು ನಿಮಗೆ ಕಿರಿಕಿರಿ ಉಂಟುಮಾಡಿದೆ. "ನನ್ನ ಕಲ್ಯಾಣ ಯೋಗ ಯಾವಾಗ ಕೂಡಿಬರಬಹುದು?" ಎಂಬ ಚಿಂತೆ ನಿಮ್ಮನ್ನು ಸದಾ ಕಾಡ್ತಾನೆ ಇದೆ.

ಆದರೆ ನಿಮ್ಮ ಜಾತಕದ 7ನೇ ಮನೆಯ ಅಧಿಪತಿಯ ಶುಭ ಸಂಚಾರ ಹಾಗೂ ದೇವಗುರು ಬೃಹಸ್ಪತಿಯ ಅನುಗ್ರಹದ ಪ್ರಕಾರ, ಮುಂದಿನ 5 ರಿಂದ 8 ತಿಂಗಳುಗಳಲ್ಲಿ (Next 5 to 8 Months) ಅತ್ಯಂತ ಯೋಗ್ಯ ಹಾಗೂ ಸಂಸ್ಕಾರಯುತ ಕುಟುಂಬದಿಂದ ವಿವಾಹ ಪ್ರಸ್ತಾಪ ಖಚಿತವಾಗಿ ಕೂಡಿಬರಲಿದೆ. ಪ್ರತಿ ಗುರುವಾರ ದಕ್ಷಿಣಾಮೂರ್ತಿಗೆ ತುಪ್ಪದ ದೀಪ ಬೆಳಗಿಸಿ ಹಾಗೂ ಗೋಕರ್ಣದಲ್ಲಿ ಕಲ್ಯಾಣ ಸಂಕಲ್ಪ ಸೇವೆ ನೆರವೇರಿಸಿ.`,
      astrologicalBasisKn: `7ನೇ ಮನೆ (ಕಳತ್ರ ಸ್ಥಾನ ${seventhLord}) ಮತ್ತು ಗುರು ಬಲದ ಸಕ್ರಿಯತೆ.`,
    ...
    },
    {
      ...
      panditScriptKn: `ನಮಸ್ಕಾರ ${name}, ನಾನ್ ನಿಮ್ಮ ಜಾತಕ ನೋಡಿದೆ. ನೋಡಿದ್ರೆ 7ನೇ ಮನೆಯ ${seventhLord} ಹಾಗೂ 4ನೇ ಮನೆಯ ಸುಖ ಸ್ಥಾನದ ಮೇಲೆ ಇರುವ ಗ್ರಹ ಪ್ರಭಾವದಿಂದ ಇತ್ತೀಚೆಗೆ ನಡೆದ ಒಂದು ಸಣ್ಣ ಮಾತುಕತೆ ಅಥವಾ ಮೂರನೇ ವ್ಯಕ್ತಿಯ ಅನಗತ್ಯ ಹಸ್ತಕ್ಷೇಪವು ದಾಂಪತ್ಯದಲ್ಲಿ ದೊಡ್ಡ ಅಂತರವನ್ನು ಸೃಷ್ಟಿಸಿದೆ. ಒಬ್ಬರ ಮಾತನ್ನು ಇನ್ನೊಬ್ಬರು ತಪ್ಪಾಗಿ ಅರ್ಥೈಸಿಕೊಳ್ಳುವುದು ಮನೆಯ ನೆಮ್ಮದಿಯನ್ನು ಹಾಳುಮಾಡಿದೆ.

ಪ್ರಸ್ತುತ ನಿಮ್ಮ ಮನೆಯಲ್ಲಿ ಒಂದು ರೀತಿಯ ಮೌನ ಮತ್ತು ಅಶಾಂತಿಯ ವಾತಾವರಣ ಮನೆಮಾಡಿದೆ. ಪ್ರೀತಿ ಇದ್ದರೂ ಮುಕ್ತವಾಗಿ ಮಾತನಾಡಲು ಹಿಂಜರಿಯುವ ಸ್ಥಿತಿ ಇದೆ. ಸಣ್ಣಪುಟ್ಟ ವಿಷಯಗಳೂ ದೊಡ್ಡ ಜಗಳವಾಗಿ ಪರಿವರ್ತನೆಯಾಗುತ್ತಿರುವುದು ನಿಮಗೆ ಪದೇ ಪದೇ ತೊಂದ್ರೆ ಕೊಡ್ತಾ ಇದೆ.

ನಿಮ್ಮ ಜಾತಕದ ಕಳತ್ರ ಸ್ಥಾನದ ಮೇಲಿನ ಗೋಚಾರ ದೋಷಗಳು ಇನ್ನೆರಡು ತಿಂಗಳಲ್ಲಿ ಶಮನಗೊಳ್ಳಲಿವೆ. ಮುಂದಿನ 2 ರಿಂದ 4 ತಿಂಗಳುಗಳಲ್ಲಿ (Next 2 to 4 Months) ಪರಸ್ಪರ ತಿಳುವಳಿಕೆ ಮರಳಿ ಬರಲಿದ್ದು, ದಾಂಪತ್ಯದಲ್ಲಿ ಸುಖ-ಶಾಂತಿ ಮರುಸ್ಥಾಪನೆಯಾಗಲಿದೆ. ದಂಪತಿ ಸಮೇತರಾಗಿ ಗೋಕರ್ಣ ಮಹಾಬಲೇಶ್ವರ ಸನ್ನಿಧಿಯಲ್ಲಿ ರುದ್ರಾಭಿಷೇಕ ನೆರವೇರಿಸಿ.`,
    ...
    },
    {
      ...
      panditScriptKn: `ನಮಸ್ಕಾರ ${name}, ನಾನ್ ನಿಮ್ಮ ಜಾತಕ ನೋಡಿದೆ. ನೋಡಿದ್ರೆ ಇದರಲ್ಲಿ 5ನೇ ಮನೆಯಲ್ಲಿ (ಸಂತಾನ ಸ್ಥಾನ) ${fifthLord} ಗ್ರಹದ ಸ್ಥಾನ ಹಾಗೂ ಪುತ್ರಕಾರಕ ಗುರುವಿನ ಸಂಚಾರದಿಂದಾಗಿ ಸಂತಾನದ ನಿರೀಕ್ಷೆಯಲ್ಲಿರುವ ನಿಮಗೆ ಈ ಹಿಂದೆ ವೈದ್ಯಕೀಯ ಪರೀಕ್ಷೆಗಳು ಸಕಾರಾತ್ಮಕವಾಗಿದ್ದರೂ ಫಲ ಸಿಗದಿರುವುದು ಕೌಟುಂಬಿಕವಾಗಿ ಮಾನಸಿಕ ಒತ್ತಡವನ್ನು ತಂದಿದೆ.

ಪ್ರಸ್ತುತ ಸಮಾಜ ಮತ್ತು ಸಂಬಂಧಿಕರ ಪ್ರಶ್ನೆಗಳನ್ನು ಎದುರಿಸಲಾಗದೆ ನೀವು ಒಳಗೆ ಕೊರಗುತ್ತಿದ್ದೀರಿ. "ದೈವಬಲ ಯಾವಾಗ ಕೈಹಿಡಿಯುತ್ತದೆ?" ಎಂಬ ನಿರೀಕ್ಷೆಯಲ್ಲಿ ಕಾಲ ಕಳಿತಾ ಇದೀರಾ.

ನಿಮ್ಮ ಜಾತಕದ 5ನೇ ಮನೆಯ ಅಧಿಪತಿಯ ಗೋಚಾರ ಸಂಚಾರದ ಪ್ರಕಾರ, ಮುಂದಿನ 6 ರಿಂದ 9 ತಿಂಗಳುಗಳಲ್ಲಿ (Next 6 to 9 Months) ಸಂತಾನ ಭಾಗ್ಯದ ಶುಭ ಸುದ್ದಿ ಮನೆತುಂಬುವ ಪ್ರಬಲ ಯೋಗವಿದೆ. ಪ್ರತಿದಿನ ಸಂತಾನ ಗೋಪಾಲ ಮಂತ್ರ ಜಪಿಸಿ ಮತ್ತು ಗೋಕರ್ಣ ಕ್ಷೇತ್ರದಲ್ಲಿ ಸುಬ್ರಹ್ಮಣ್ಯ ಸ್ವಾಮಿಗೆ ಕ್ಷೀರಾಭಿಷೇಕ ಸಮರ್ಪಿಸಿ.`,
      astrologicalBasisKn: `5ನೇ ಮನೆ (ಪುತ್ರ ಸ್ಥಾನ ${fifthLord}) ಮತ್ತು ದೇವಗುರು ಬೃಹಸ್ಪತಿಯ ಗೋಚಾರ ಸಂಚಾರ.`,
    ...
    // 3. MIND & HEALTH
    {
      ...
      panditScriptKn: `ನಮಸ್ಕಾರ ${name}, ನಾನ್ ನಿಮ್ಮ ಜಾತಕ ನೋಡಿದೆ. ನೋಡಿದ್ರೆ ಇದರಲ್ಲಿ ಇರುವಂತಹ ಒಂದು ೪ನೇ ಮನೇಲಿ ಅಥವಾ ಚಂದ್ರನ ${moonHouse}ನೇ ಮನೆಯ ತ್ರಿಕ ಸ್ಥಾನದಲ್ಲಿ ಗ್ರಹ ಸಂಯೋಗ ಇರುವುದರಿಂದ ನಿಮಗೆ ಸ್ವಲ್ಪ ಇವಾಗ ತೊಂದರೆ ಹಂಗೆ ಕಾಣಿಸ್ತಾ ಇದೆ, ಮನಸ್ಸಲ್ಲಿ ನೆಮ್ಮದಿ ಇಲ್ಲ, ಅಥವಾ ಏನೋ ಒಂದು ಯೋಚನೆ, ನೋವು ನಿಮ್ಮನ್ನ ಕಾಡ್ತಾನೆ ಇರುವುದು.

ಈ ತರದ್ದೆಲ್ಲ ಕೆಲವೊಂದು ಪರಿಸ್ಥಿತಿಗಳಿಂದ ನೀವು ನಿದ್ರಾಹೀನತೆಯಾಗಿ ರಾತ್ರಿ 2:00 AM ರಿಂದ 4:30 AM ರ ಹೊತ್ತಿಗೆ ಏನೋ ಯೋಚನೆ ಮಾಡ್ತಾ ನಿಮ್ಮ ಕಾಲ ಕಳಿತಾ ಇದೀರಾ. ಹೊರಗೆ ನಗುತ್ತಾ ಕಂಡರೂ ಎದೆಯೊಳಗೆ ಸದಾ ಒಂದು ಆತಂಕದ ಕಂಪನವಿದೆ; ಈ ತರದ್ದು ನಿಮಗೆ ಪದೇ ಪದೇ ತೊಂದ್ರೆ ಕೊಡ್ತಾ ಇರಬಹುದು.

ನಿಮ್ಮ ಜನ್ಮ ಲಗ್ನ ಬಲ ದೃಢವಾಗಿದೆ. ಮುಂದಿನ 2 ರಿಂದ 3 ತಿಂಗಳುಗಳಲ್ಲಿ (Next 2 to 3 Months) ಈ ಆತಂಕದ ಕಾರ್ಮೋಡ ಸಂಪೂರ್ಣವಾಗಿ ಕರಗಲಿದ್ದು, ಮನಸ್ಸಿಗೆ ಪ್ರಶಾಂತತೆ ಮರಳಲಿದೆ. ರಾತ್ರಿ ಮಲಗುವ ಮುನ್ನ 11 ಬಾರಿ 'ಓಂ ನಮಃ ಶಿವಾಯ' ಜಪಿಸಿ ಹಾಗೂ ${rudraName} ಧಾರಣೆ ಮಾಡಿ.`,
      astrologicalBasisKn: `ಚಂದ್ರ ಗ್ರಹದ ${moonHouse}ನೇ ಸ್ಥಾನ ಮತ್ತು ಪಂಚಾಂಗ ಜಲ ತತ್ವದ ಸೂಕ್ಷ್ಮ ಪ್ರಭಾವ.`,
    ...
    },
    {
      ...
      panditScriptKn: `ನಮಸ್ಕಾರ ${name}, ನಾನ್ ನಿಮ್ಮ ಜಾತಕ ನೋಡಿದೆ. ನೋಡಿದ್ರೆ ನಿಮ್ಮ ${lagnaRashi} ಲಗ್ನದ ಆಕರ್ಷಕ ವ್ಯಕ್ತಿತ್ವ ಮತ್ತು ಪ್ರಗತಿಯನ್ನು ನೋಡಿ ಆಪ್ತ ವಲಯದಲ್ಲೇ ಕೆಲವರಿಗೆ ತೀವ್ರ ಅಸೂಯೆ ಉಂಟಾಗಿದೆ. ಇತ್ತೀಚೆಗೆ ಯಾವುದೇ ಶುಭ ಕೆಲಸ ಆರಂಭಿಸಿದಾಗಲೆಲ್ಲಾ ಅನಿರೀಕ್ಷಿತ ಅಡೆತಡೆಗಳು ಅಥವಾ ಮನೆಯಲ್ಲಿ ಅಶಾಂತಿಯ ವಾತಾವರಣ ಉಂಟಾಗಿದೆ.

ಪ್ರಸ್ತುತ ನೀವು ಮನೆಯೊಳಗೆ ಕಾಲಿಡುತ್ತಿದ್ದಂತೆಯೇ ಒಂದು ರೀತಿಯ ಭಾರವಾದ ವಾತಾವರಣ ಮತ್ತು ನಿಶ್ಯಕ್ತಿ ಅನುಭವಿಸುತ್ತಿದ್ದೀರಿ. ನಿಮ್ಮ ಉತ್ಸಾಹವೆಲ್ಲಾ ಸೋರಿಹೋಗುತ್ತಿರುವಂತೆ ಭಾಸವಾಗ್ತಾ ಇದೆ.

ಇದು ನರ ದೃಷ್ಟಿ ಮತ್ತು ನಕಾರಾತ್ಮಕ ಶಕ್ತಿಯ ತಾತ್ಕಾಲಿಕ ಪ್ರಭಾವ. ಮುಂದಿನ 1 ರಿಂದ 2 ತಿಂಗಳಲ್ಲಿ (Next 1 to 2 Months) ರಕ್ಷಾ ಕವಚದ ಪ್ರಭಾವದಿಂದ ಸಕಲ ದೋಷಗಳು ನಿವಾರಣೆಯಾಗಲಿವೆ. ಮನೆಯ ಮುಖ್ಯದ್ವಾರಕ್ಕೆ ಕಲ್ಲುಪ್ಪು-ನಿಂಬೆಹಣ್ಣಿನ ದೃಷ್ಟಿ ತೆಗೆದು ಹಾಕಿ ಮತ್ತು ಗೋಕರ್ಣ ಕ್ಷೇತ್ರದಲ್ಲಿ ಶತ್ರು ಸಂಹಾರ ಸೇವೆ ಸಮರ್ಪಿಸಿ.`,
    ...
    // 4. WEALTH & DEBT
    {
      ...
      panditScriptKn: `ನಮಸ್ಕಾರ ${name}, ನಾನ್ ನಿಮ್ಮ ಜಾತಕ ನೋಡಿದೆ. ನೋಡಿದ್ರೆ 6ನೇ ಮನೆಯ (ಋಣ ಸ್ಥಾನ) ${sixthLord} ಹಾಗೂ 2ನೇ ಮನೆಯ ಧನಕೋಶದ ಮೇಲೆ ಪಾಪಗ್ರಹಗಳ ಗೋಚಾರ ಪ್ರಭಾವದಿಂದ ಕಳೆದ ಕೆಲವು ತಿಂಗಳುಗಳಿಂದ ಬಂದ ಒಂದು ಅನಿರೀಕ್ಷಿತ ತುರ್ತು ಖರ್ಚು ನಿಮ್ಮನ್ನು ಸಾಲದ ಸುಳಿಗೆ ಸಿಲುಕಿಸಿದೆ.

ಪ್ರಸ್ತುತ ನಿಮ್ಮ ಪರಿಸ್ಥಿತಿ ಎಂದರೆ, ಕೈಗೆ ಬಂದ ಹಣ ಕಣ್ಣಿಗೆ ಕಾಣದಂತೆ ಸೋರಿಹೋಗುತ್ತಿದೆ. ಸಾಲದ ಕರೆಗಳು ಮತ್ತು ಜವಾಬ್ದಾರಿಗಳು ನಿಮ್ಮ ಆತ್ಮಗೌರವಕ್ಕೆ ಧಕ್ಕೆ ತರುತ್ತಿವೆ. ಇದರಿಂದಾಗಿ ಗೌಪ್ಯವಾಗಿ ಮಾನಸಿಕ ಯಾತನೆ ಅನುಭವಿಸುತ್ತಿದ್ದೀರಿ.

ನಿಮ್ಮ ಜಾತಕದ 11ನೇ (ಲಾಭ) ಮತ್ತು 6ನೇ ಮನೆಗಳ ಗ್ರಹ ಚಲನೆಯ ಪ್ರಕಾರ, ಮುಂದಿನ 4 ರಿಂದ 7 ತಿಂಗಳುಗಳಲ್ಲಿ (Next 4 to 7 Months) ಹೊಸ ಆದಾಯದ ಮೂಲ ತೆರೆದುಕೊಳ್ಳಲಿದ್ದು, ಸಾಲದ ಬಹುಪಾಲು ಹೊರೆ ಇಳಿಯಲಿದೆ. ನಿತ್ಯವೂ ಋಣವಿಮೋಚಕ ನರಸಿಂಹ ಸ್ತೋತ್ರ ಪಠಿಸಿ.`,
      astrologicalBasisKn: `6ನೇ (ಋಣ) ಮತ್ತು 11ನೇ (ಲಾಭ) ಮನೆಗಳ ಮೇಲಿನ ಗೋಚಾರ ಗ್ರಹ ಸಂಚಾರ.`,
      immediateRemedyKn: `ಪ್ರತಿದಿನ ಋಣವಿಮೋಚಕ ನರಸಿಂಹ ಸ್ತೋತ್ರ ಪಠಿಸಿ ಮತ್ತು ಗೋಕರ್ಣದಲ್ಲಿ ನವಗ್ರಹ ಶಾಂತಿ ಸೇವೆ ಮಾಡಿಸಿ.`
    }
  ];
};
...
export const generatePanchangaAngaSynthesis = (
  ...
  const p1 = `ನಮಸ್ಕಾರ ${devoteeNameFormatted}, ನಾನ್ ನಿಮ್ಮ ಜಾತಕ ನೋಡಿದೆ. ನೋಡಿದ್ರೆ ಇದರಲ್ಲಿ ಇರುವಂತಹ ನಿಮ್ಮ ${lagna} ಲಗ್ನ ಹಾಗೂ ${kundli.moonSign.english} ರಾಶಿಯ ${moonNak} ನಕ್ಷತ್ರದ ಗ್ರಹ ಸಂಯೋಗವನ್ನು ನೋಡಿದರೆ, ${currentDiagnosis.technicalAspects.fourthHouseDetail}. ನಿಮಗೆ ಸ್ವಲ್ಪ ಇವಾಗ ತೊಂದರೆ ಹಂಗೆ ಕಾಣಿಸ್ತಾ ಇದೆ, ಮನಸ್ಸಲ್ಲಿ ನೆಮ್ಮದಿ ಇಲ್ಲ, ಅಥವಾ ಏನೋ ಒಂದು ಯೋಚನೆ, ನೋವು ನಿಮ್ಮನ್ನ ಕಾಡ್ತಾನೆ ಇರುವುದು. ಈ ತರದ್ದೆಲ್ಲ ಕೆಲವೊಂದು ಪರಿಸ್ಥಿತಿಗಳಿಂದ ನೀವು ನಿದ್ರಾಹೀನತೆಯಾಗಿ ರಾತ್ರಿ 2:00 AM ರಿಂದ 4:30 AM ರ ವೇಳೆಗೆ ಏನೋ ಯೋಚನೆ ಮಾಡ್ತಾ ನಿಮ್ಮ ಕಾಲ ಕಳಿತಾ ಇದೀರಾ, ಹೌದಲ್ಲವೇ?`;
